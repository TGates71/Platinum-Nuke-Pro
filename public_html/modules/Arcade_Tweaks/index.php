...

{
    ...
    $content .= "<strong>Search:<strong>&nbsp;<input type=\"text\" name=\"srchstring\" value=\"$srchstring\" size=\"10\" title=\"Use Wildcards * and ? such as 'yeti*'\">\n";
...

{
    ...
    switch ($selectaction) {
        ...
        case "changesize":
            ...
            echo "<u>New window size</u>:  <strong>Width:</strong> <input type=\"text\" name=\"gwidth\" value=\"\" size=\"4\">";

            echo "   <strong>Height:</strong> <input type=\"text\" name=\"gheight\" value=\"\" size=\"4\">";
...

{
    ...
    $content = "<font class='content'><strong>Goto Pages:&nbsp;&nbsp;</strong>";
...

{
    ...
    if ($fix = 'commentstable') {
        ...
        if ($commenttableexist) {
            ...
            "Cannot fix your <strong>Comments Table</strong>, I dont find the table in database.";
...

{
    ...
    if ($CategoryNotSynchronized) {
        ...
        echo "<img src='modules/$module_name/images/icon_warn.gif' border=0 width=16 height=16><strong>$CategoryNotSynchronized</strong> dont match. [ <a href='modules.php?name=$module_name&m_op=syncallcat'>Resync All Categories</a> ]";
    ...
    if ($commenttableexist) {
        ...
        echo $missingcomment? "<br /><br /><img src='modules/$module_name/images/icon_warn.gif' border=0 width=16 height=16><strong>" . $missingcomment . " games dont have comments</strong> [ <a href='modules.php?name=$module_name&amp;m_op=fixdb&amp;fix=commentstable'>Fix Comments Table</a> ]<br />"
