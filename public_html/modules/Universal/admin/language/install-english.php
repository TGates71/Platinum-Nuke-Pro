...
define("_UMIINSTALLTITLE","Universal Module Installation");
define("_UMINOTALLOWED","You are not allowed to access this file");

define("_UMIWARNBIG","WARNING");
define("_UMICANTWRITE1","I cannot write to");
define("_UMICANTWRITE2","Please make this file writable else the install will not be able to be completed");
define("_UMICANTWRITE3","Please");
define("_UMICANTWRITE4","to try again after you make the file writable");
define("_UMICLICKHERE","Click Here");

define("_UMIINSTALLTITLE2","Universal Module 2.5 Installation System");
define("_UMINEWINSTALL","New Install");
define("_UMINEWINSTALLMESS1","Click this button, if you are installing for the first time");
define("_UMINEWINSTALLMESS2","This will drop all existing tables");
define("_UMINEWINSTALLMESS3","If they have your chosen prefix");
define("_UMIUPGRADEFROM","Upgrade from");
define("_UMIUPGRADE1MESS","Click this button, if you are upgrading from");

define("_UMITYPEMAINPREFIX","Please type your main prefix for your database");
define("_UMIDEFAULTPREFIX","If you do not enter one the default 'items' will be used");
define("_UMICONTINUEINSTALL","Continue Installation");
...
define("_ADMINONLY","Admin's Only");
...
define("_UMIINSTALLCOMPLETE","Install Complete");
define("_UMIPLEASEDELETE","Please delete this file immediately to prevent anyone");
define("_UMIRESETDATABASE","resetting your database");
define("_UMIUPGRADECOMPLETE","Upgrade Complete");
