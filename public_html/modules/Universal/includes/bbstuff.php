...
// BBCode Parser for the Open Site Manager News module                    
// Copyright (c) 2003 by ArtificialIntel (http://www.opensitemanager.org)               
// All Rights Reserved          
// No modifications where made to this file.                        

if (stristr($_SERVER['SCRIPT_NAME'], "bbstuff.php")) {
...
function parse_bbcode($hometext, $bbcode_uid){
		...
		$bbcode_tpl['code_open'] = "<table width=\"85%\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\" align=\"center\"><tr><td><span class=\"genmed\"><strong>"._UMBBCODE.":</strong></span></td></tr><tr><td class=\"code\">";
		$bbcode_tpl['code_close'] = "</td></tr></table>";
		$bbcode_tpl['align_open'] = "<div style=\"text-align:$1\">";
		$bbcode_tpl['align_close'] = "</div>";
		$bbcode_tpl['quote_open'] = "<table width=\"85%\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\" align=\"center\"><tr><td><span class=\"genmed\"><strong>"._UMBBQUOTE.":</strong></span></td></tr><tr><td class=\"quote\">";
		$bbcode_tpl['quote_close'] = "</td></tr></table>";
		$bbcode_tpl['quote_username_open'] = "<table width=\"85%\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\" align=\"center\"><tr><td><span class=\"genmed\"><strong>$1 "._UMBBWROTE.":</strong></span></td></tr><tr><td class=\"quote\">";
...
function smilies_pass( $hometext )
{
   static $orig, $repl;
   if( !isset( $orig ) )
   {
