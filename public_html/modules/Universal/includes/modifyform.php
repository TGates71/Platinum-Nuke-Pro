...
if (stristr($_SERVER['SCRIPT_NAME'], "modifyform.php")) {
...
<?php
    ...
    $sel = "";
			...
			echo "      <td width=\"80%\">\n";
			echo "      <input type=\"text\" name=\"itemauthor\" size=\"27\" maxlength=\"100\" onMouseOver=\"helpline('author')\" value=\"$itemauthor\"> ("._NEWITEMAUTHOR.".)\n";
			echo "      </td>\n";
			echo "    </tr>\n";
			echo "    <tr>\n";
			...
			echo "      <td width=\"80%\">\n";
			echo "      <input type=\"text\" name=\"itemtitle\" size=\"27\" maxlength=\"120\" onMouseOver=\"helpline('title')\" value=\"$itemtitle\"> ("._NEWTITLEMESS.".)\n";
			echo "      </td>\n";
			echo "    </tr>\n";
			echo "    <tr>\n";
			...
			echo "      <td width=\"80%\"><input type=\"text\" name=\"descrip\" size=\"27\" value=\"$descrip\" onMouseOver=\"helpline('descript')\" maxlength=\"120\"> ("._NEWDESCRIPMESS.".)\n";
			echo "      </td>\n";
			echo "    </tr>\n";
			echo "    <tr>\n";
			echo "      <td width=\"20%\" valign=\"top\" rowspan=\"2\">"._NEWCONTENT.":<br />\n";
			echo "      ("._NEWHTML.").\n";
			echo "<br /><center><center><input type=\"button\" onClick=\"javascript:pagebreak()\" onMouseOver=\"helpline('pagebreak')\" value=\""._INSERTPB."\"></center>\n";		
			echo "</td>";
