...
{
    global $CONFIG, $album, $CPG_URL, $field_user_name, $field_user_id;
    if (GALLERY_ADMIN_MODE) {
...
echo <<<EOT
        ...
        <form method="post" action="$CPG_URL&amp;file=db_input" enctype="multipart/form-data" accept-charset="$chset">
