...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Spiacenti, hai giÃ  votato questa immagine',
...
Gli amministratori di <strong>{SITE_NAME}</strong> rimuoveranno tutto quello che non sarÃ  ritenuto compatibile con le finalitÃ  ed il decoro del sito.Ti chiediamo di rispettare il lavoro degli altri utenti e del webmaster.<br />
<br />
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Cerca nuove immagini',
        ...
        'warning' => 'Attento',
        'change_perm' => 'lo script non puÃ² scrivere in questa directory, fai il chmod a 755 o 777 e riprova!',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : immagine aggiunta con successo' . '<li><strong>DP</strong> : immagine giÃ  presente nel database' . '<li><strong>PB</strong> : immagine non aggiunta a causa della errata configurazione del server o del chmod delle cartelle' . '<li>Se OK, DP, PB non appaiono clicca sulla immagine per vedere quale errore Ã¨ stato causato dal PHP' . '<li>Se il tuo browser va in timeout, premi il tasto Aggiorna' . '</ul>',
