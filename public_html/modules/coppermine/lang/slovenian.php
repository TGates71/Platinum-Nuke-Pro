...
$lang_meta_album_names = array('random' => 'Nakljuène slike',
...
$lang_errors = array('access_denied' => 'Nimaš pravic za dostop do te strani.',
...
$lang_user_admin_menu = array('albmgr_lnk' => 'Ustvari/naroèi svoj album',
...
$lang_album_list = array('album_on_page' => 'Št. albumov:%d (št. strani:%d)'
    );
...
$lang_get_pic_data = array('n_comments' => 'Št. komentarjev:%s',
...
// File admin.php
// ------------------------------------------------------------------------- //
if (defined('ADMIN_PHP')) $lang_admin_php = array(0 => 'Zapušèam administracijo...',
...
// for postnuke change
        ...
        'Seznam albumov',
        array(
            'Širina glavne tabele (pixli ali %)', 'main_table_width', 0),
        array(
            'Število nivojev za prikaz kategorij', 'subcat_level', 0),
        array(
            'Število albumov na strani', 'albums_per_page', 0),
        array(
            'Število kolon za prikaz albumov', 'album_list_cols', 0),
        array(
        ...
        'Prikaz ikon',
        array(
            'Število kolon na strani z ikonami', 'thumbcols', 0),
        array(
            'Število vrstic na strani z ikonami', 'thumbrows', 0),
        array(
            'Max. št. tabulatorjev', 'max_tabs', 0),
        array(
            'Prikaži opis slike (zraven imena) pod ikono', 'caption_in_thumbview', 1),
        array(
            'Prikaži število komentarjev pod ikono', 'display_comment_count', 1),
        array(
            'Privzeto sortiranje slik', 'default_sort_order', 3),
        array(
            'Minimalno število ocen za sliko, da se uvrsti na seznam  \'naj-ocene\'', 'min_votes_for_rating', 0),
        array(
        ...
        array(
            'Širina tabele za prikaz slik (pixli ali %)', 'picture_table_width', 0),
        array(
            'Informacija o sliki je privzeto vidna', 'display_pic_info', 1),
        array(
            'Izloèi grde besede v komentarjih', 'filter_bad_words', 1),
        array(
            'Dovoli smeškote v komentarjih', 'enable_smilies', 1),
        array(
        ...
        array(
            'Max. število zankov v besedi', 'max_com_wlength', 0),
        array(
            'Max. število vrstic komentarja', 'max_com_lines', 0),
        array(
            'Max. velikost komentarja', 'max_com_size', 0),
        array(
            'Prikaži filmski trak z ikonami', 'display_film_strip', 1),

        array(
            'Št. ikon na traku', 'max_film_strip_items', 0),
...
//'Pictures and thumbnails settings',
        ...
        array(
            'Velikost uporabi za širino ali višino ali razmerje ikone <strong>*</strong>', 'thumb_use', 7),

        array(
            'Ustvari vmesne slike', 'make_intermediate', 1),
        array(
            'Max. širina ali višina vmesnih slik <strong>*</strong>', 'picture_width', 0),
        array(
            'Max. velikost datotek/slik (kB)', 'max_upl_size', 0),
        array(
            'Max. širina ali višina dodanih slik (pixli)', 'max_upl_width_height', 0), 
        // 'User settings',
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Prikaži ikone privatnih albumov neprijavljenim uporabnikom', 'show_private', 1),
        ...
        array(
            'Naèin kreiranja ikon', 'thumb_method', 2),
        array(
        ...
        array(
            'Prikaži EXIF podatke v JPEG datotekah', 'read_exif_data', 1),
        array(
        ...
        array(
            'Ime za piškotke, ki jih uporablja galerija', 'cookie_name', 0),
        array(
            'Pot do piškotkov', 'cookie_path', 0),
        array(
            'Kodiranje strani', 'charset', 4), 
        // 'Miscellaneous settings',
        'Ostale nastavitve',
        array(
            'Vkljuèi naèin za odkrivanje napak', 'debug_mode', 1),
        array(
...
if (defined('DB_INPUT_PHP'))
    $lang_db_input_php =
    array('empty_name_or_com' => 'Vpisati moraš svoje ime in komentar',
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Res želiš pobrisati to sliko? \\nTudi komentarji od nje bodo pobrisani.',
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Klikni sliko, da zapreš to okno',
...
// File ecard.php
// ------------------------------------------------------------------------- //
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'Pošlji e-razglednico',
        'invalid_email' => '<strong>Opozorilo</strong>: napaèni e-mail naslov!',
...
if (defined('INDEX_PHP')) {
    $lang_index_php = array('welcome' => 'Dobrodošel!'
        );

    $lang_album_admin_menu = array('confirm_delete' => 'Res želiš pobrisati ta album? \\nVse slike in komentarji bodo pobriani.',
        'delete' => 'BRISANJE',
        'modify' => 'LASTNOSTI',
        'edit_pics' => 'UREJANJE',
        );
    ...
    $lang_list_categories = array('home' => 'Domov',
        'stat1' => 'Št. slik:<strong>[pictures]</strong> - št. albumov:<strong>[albums]</strong> - št. kategorij:<strong>[cat]</strong>  - št. komentarjev:<strong>[comments]</strong> - št. ogledov:<strong>[views]</strong>',
        'stat2' => 'Št. slik:<strong>[pictures]</strong> - št. albumov:<strong>[albums]</strong> - št. ogledov<strong>[views]</strong>',
        'xx_s_gallery' => 'Galerija od %s',
        'stat3' => 'Št. slik:<strong>[pictures]</strong> - št. albumov:<strong>[albums]</strong> - št. komentarjev:<strong>[comments]</strong>  - št. ogledov:<strong>[views]</strong>'
        );
    ...
    $lang_list_albums = array('n_pictures' => 'Št. slik:%s',
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Oprosti, ampak to sliko si že ocenil',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Iskanje novih slik',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong>: pomeni, da so slike uspešno dodane' . '<li><strong>DP</strong>: pomeni, da je slika duplikat in je že v bazi' . '<li><strong>PB</strong>: pomeni, da slike ni možno dodati. Preveri nastavitve in pravice za direktorij v katerem se nahajajo' . '<li>Èe ne vidiš oznak OK, DP ali PB, klikni na manjkajoèo slikico za prikaz napake, ki jo generira PHP' . '<li>Za osvežitev prikaza pritisni tipko reload  v svojem brskalniku' . '</ul>',
