...
// File config.php
// ------------------------------------------------------------------------- //
if (defined('CONFIG_PHP')) $lang_config_php = array('title' => 'Konfigurasjon',
...
if (defined('CONFIG_PHP')) $lang_config_data = array('Generelle instillinger',
...
// for postnuke change
       ...
       // 'Pictures and thumbnails settings',
        ...
        array('Maks bredde og høyde på miniatyrbilder <strong>*</strong>', 'thumb_width', 0),
        array(
        ...
        array('Maks høyde eller bredde på mellomliggende bilde <strong>*</strong>', 'picture_width', 0),
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array('Adresse til ImageMagick / netpbm \'konverterings\' verktøy (eksempel /usr/bin/X11/)', 'impath', 0),
        ...
        array('Mappen for brukerenes bilder <strong>*</strong>', 'userpics', 0),
        array('forhåndsvalgt navn på medlemsbilder <strong>*</strong>', 'normal_pfx', 0),
        array('fårhåndsvalgt navn på miniatyrbilder <strong>*</strong>', 'thumb_pfx', 0),
...
// File login.php
// ------------------------------------------------------------------------- //
if (defined('LOGIN_PHP')) $lang_login_php = array('login' => 'Logg inn',
...
// File logout.php
// ------------------------------------------------------------------------- //
if (defined('LOGOUT_PHP')) $lang_logout_php = array('logout' => 'Logg ut',
        'bye' => 'Farvell %s ...',
...
// File banning.php
// ------------------------------------------------------------------------- //
if (defined('BANNING_PHP')) $lang_banning_php = array('title' => 'Utvis brukere',
