...
$lang_meta_album_names = array('random' => 'Tilfældige billeder',
...
$lang_album_list = array('album_on_page' => '%d album på %d side(r)'
    );
...
$lang_rate_pic = array('rate_this_pic' => 'Bedøm dette billede ',
...
// ------------------------------------------------------------------------- //
if (defined('SMILIES_PHP')) $lang_smilies_inc_php = array('Exclamation' => 'Udråb',
        'Question' => 'Spørgsmål',
...
// File catmgr.php
// ------------------------------------------------------------------------- //
if (defined('CATMGR_PHP')) $lang_catmgr_php = array('miss_param' => 'Parameter Parameters obligatorisk ved \'%s\'operation ej udført!',
...
if (defined('CONFIG_PHP')) 
	...
	'Generelle indstillinger',
        ...
        array('Mål adressen for nuke folder ie http://www.mysite.tld/html/', 'ecards_more_pic_target', 0),
        array('Sprog', 'lang', 5),
// for postnuke change
        ...
        array(
            'Vis øverste album niveaus minibilleder i kategorier', 'first_level', 1),
       ...
       // 'Pictures and thumbnails settings',
        ...
        array('Maks. dimension på minibilleder <strong>*</strong>', 'thumb_width', 0),
        array(
            'Brug dimension ( bredde, højde eller maksimum af de to til minibilleder )<strong>*</strong>', 'thumb_use', 7),
        array('Opret mellemstore billeder', 'make_intermediate', 1),
        array('Max bredde eller højde for et mellemstort billede <strong>*</strong>', 'picture_width', 0),
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array('Foranstillet navn på mellembilleder <strong>*</strong>', 'normal_pfx', 0),
        array('Foranstillet navn på minibilleder <strong>*</strong>', 'thumb_pfx', 0),
...
array(
'Show Coppermine Update Alert to Admin', 'showupdate', 1), // new 1.2.2'<br /><div align="center">(*) Felter markeret med * skal skiftes hvis du allerede har billeder i dit galleri</div><br />'
        );
// ------------------------------------------------------------------------- //
// File db_input.php
// ------------------------------------------------------------------------- //
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Er du sikker på du ønsker at SLETTE dette billede? \\nKommentarer bliver også slettet.',
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Klik på billedet for at lukke dette vindue',
        );
} 
// ------------------------------------------------------------------------- //
// File ecard.php
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Gruppe navn',
        ...
        'note1' => '<strong>(1)</strong> Upload i det offentlige album, kræver admin godkendelse',
        'note2' => '<strong>(2)</strong> Upload i et album som tilhører brugeren, kræver admin godkendelse',
        'notes' => 'Noter',
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_album_admin_menu = array('confirm_delete' => 'Er du sikker på du vil SLETTE dette album? \\nAlle billeder og kommentarer vil også blive slettet.',
        'delete' => 'SLET',
        'modify' => 'REDIGER',
        'edit_pics' => 'REDIGER BILLEDER',
        );
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Beklager, men du har allerede stemt på dette billede',
...
// if (defined('SEARCH_PHP'))
    $lang_search_php = array(0 => 'Søg i billede samlingen',
        );
// ------------------------------------------------------------------------- //
// File searchnew.php
// ------------------------------------------------------------------------- //
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Søg i nye billeder',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : Betyder at billedet blev tilføjet' . '<li><strong>DP</strong> : Betyder at billedet er en duplikat og det allerede ligger i databasen' . '<li><strong>PB</strong> : Betyder at billedet ikke kunne tilføjes, kontrollerer venligst din konfiguration samt tilladelser på de respektive mapper' . '<li>Hvis OK, DP, PB \'signalet\' ikke kommer frem, klik da på de manglede billeder for at se om der da fremkommer nogle fejlmeddelelser som frembringes af PHP' . '<li>Hvis din browser laver time-out, da opdater den browser' . '</ul>',
        );
// ------------------------------------------------------------------------- //
// File thumbnails.php
// ------------------------------------------------------------------------- //
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array('title' => 'Administrer bruger',
        ...
        'user_loc' => 'Brugers placering',
        'user_interests' => 'Brugers interesser',
        'user_occ' => 'Brugers beskæftigelse',
        );
// ------------------------------------------------------------------------- //
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Ændre størrelse på billeder',
