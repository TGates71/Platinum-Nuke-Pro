...
$lang_meta_album_names = array('random' => 'Sluèajno odabrana slika',
...
$lang_errors = array('access_denied' => 'Ne možete pristupiti ovoj stranici.',
...
$lang_gallery_admin_menu = array('upl_app_lnk' => 'Dopuštenje uploada',
...
'Album list view',
array(
'Širina glavne tablice (pikseli ili %)', 'main_table_width', 0),
array(
...
'Thumbnail view',
array(
'Broj stupaca na stranici sa slièicama', 'thumbcols', 0),
array(
'Broj redova na stranici sa slièicama', 'thumbrows', 0),
array(
...
array(
'Pokaži broj komentara ispod slièice', 'display_comment_count', 1),
array(
...
'Image view &amp; Comment settings',
array(
'Širina tablice za prikaz slike (pixels or %)', 'picture_table_width', 0),
array(
'Informacije o slici se vide po dafaultu', 'display_pic_info', 1),
array(
'Izbaci ružne rijeèi u komentarima', 'filter_bad_words', 1),
array(
'Omoguæi smješke u komentarima', 'enable_smilies', 1),
array(
...
array(
'Max dužina za opis slike', 'max_img_desc_length', 0),
array(
'Max broj znakova u rijeèi', 'max_com_wlength', 0),
array(
'Max broj linija u komentaru', 'max_com_lines', 0),
array(
'Max dužina komentara', 'max_com_size', 0),
array(
'Pokaži film strip', 'display_film_strip', 1),
array(
'Broj slièica u film stripu', 'max_film_strip_items', 0),
array(
...
array(
'Max dimenzija slièice <strong>*</strong>', 'thumb_width', 0),
array(
'Korištena velièina ( width or height or Max aspect for thumbnail )<strong>*</strong>', 'thumb_use', 7),
array(
'Napravi srednje-velike slike', 'make_intermediate', 1),
array(
'Max širina ili visina srednje-velike slike <strong>*</strong>', 'picture_width', 0),
array(
'Max velièina za uploadane slike (KB)', 'max_upl_size', 0),
array(
'Max širina ili visina za uploadane slike (pixels)', 'max_upl_width_height', 0),
//'User settings',
'User settings',
array(
'Želite li dopustiti registraciju novih korisnika', 'allow_user_registration', 1),
array(
'Za registraciju novih korisnika potrebna je e-mail potvrda', 'reg_requires_valid_email', 1),
array(
'Želite li dopustiti da dva korisnika imaju istu email adresu', 'allow_duplicate_emails_addr', 1),
array(
...
'Pictures and thumbnails advanced settings',
array(
'Pokaži ikonu osobnih albuma nelogiranom korisniku', 'show_private', 1),
array(
'Znakovi zabranjeni u imenima dokumenata', 'forbiden_fname_char', 0),
array(
'Dopušteni doèeci dokumenata za upload slike', 'allowed_file_extensions', 0),
array(
'Metoda za mijenjanje velièine slike', 'thumb_method', 2),
array(
'Put do ImageMagick / netpbm \'convert\' programa (example /usr/bin/X11/)', 'impath', 0),
array(
'Dopuštene vrste slika (vrijedi samo za ImageMagick)', 'allowed_img_types', 0),
array(
'Opcije komandne linije za ImageMagick', 'im_options', 0),
array(
'Proèitaj EXIF podatke u JPEG dokumentima', 'read_exif_data', 1),
array(
'Read IPTC data in JPEG files', 'read_iptc_data', 1), // new in cpg1.2.0nuke
array(
'Album direktorij <strong>*</strong>', 'fullpath', 0),
array(
'Direktorij za korisnièke slike <strong>*</strong>', 'userpics', 0),
array(
'Prefix za srednje-velike slike <strong>*</strong>', 'normal_pfx', 0),
array(
'Prefix za slièice <strong>*</strong>', 'thumb_pfx', 0),
array(
...
'Cookies &amp; Charset settings',
array(
'Naziv cookie-ja korištenog u skripti', 'cookie_name', 0),
array(
'Put cookie-ja korištenog u skripti', 'cookie_path', 0),
array(
...
// File ecard.php
// ------------------------------------------------------------------------- //
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'Pošaljite ovu e-razglednicu',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Naziv grupe',
        ...
        'note1' => '<strong>(1)</strong> Za upload u javni album potrebno dopuštenje administratora',
        'note2' => '<strong>(2)</strong> Za upload u album koji pripada korisniku potrebno dopuštenje administratora',
        'notes' => 'Napomena'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_list_categories = array('home' => 'Poèetna stranica',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Pretraga novih slika',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : znaèi da je slika uspješno dodana' . '<li><strong>DP</strong> : znaèi da je slika duplikat i da je veæ u bazi podataka' . '<li><strong>PB</strong> : znaèi da sliku nije moguæe dodati, provjerite vlastitu konfiguraciju i dozvolu direktorija gdje su slike smještene' . '<li>Ako OK, DP, PB \'signs\' se ne pojave kliknite na puknutu sliku da vidite koju je grešku napravio PHP' . '<li>Ako je vrijeme isteklo, pritisnite refresh' . '</ul>',
        );
// ------------------------------------------------------------------------- //
// File thumbnails.php
// ------------------------------------------------------------------------- //
...
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Promijeni velièinu slike',
