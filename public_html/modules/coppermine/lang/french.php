...
define('PIC_VIEWS', 'Téléchargements');
...
$lang_errors = array('access_denied' => 'Vous n\'avez pas la permission d\'accéder à cette page.',
...
// File theme.php
// ------------------------------------------------------------------------- //
$lang_main_menu = array('alb_list_title' => 'Aller à la liste des albums',
...
$lang_user_admin_menu = array('albmgr_lnk' => 'Créer / classer mes albums',
    'modifyalb_lnk' => 'Modifier mes albums',
    'my_prof_lnk' => 'Mon profil',
    );

$lang_cat_list = array('category' => 'Catégorie',
    'albums' => 'Albums',
    'pictures' => 'Images',
    );
...
$lang_img_nav_bar = array('thumb_title' => 'Retourner à la page des vignettes',
...
// File admin.php
// ------------------------------------------------------------------------- //
if (defined('ADMIN_PHP')) $lang_admin_php = array(0 => 'Déconnexion du mode administrateur...',
...
// File catmgr.php
// ------------------------------------------------------------------------- //
if (defined('CATMGR_PHP')) $lang_catmgr_php = array('miss_param' => 'Les paramètres requis pour l\'\'%s\'operation sont manquants !',
...
// for postnuke change
        ...
        array(
            'Nombre de niveaux de catégories à afficher', 'subcat_level', 0),
        array(
            'Nombre d\'albums à afficher', 'albums_per_page', 0),
        array(
        ...
        array(
            'Afficher les vignettes de l\'album du premier niveau avec la catégorie', 'first_level', 1), 
        // 'Thumbnail view',
        ...
        array(
            'Nombre maximal d\'onglets à afficher', 'max_tabs', 0),
        array(
            'Afficher la légende de l\'image (en plus de son titre) sous la vignette', 'caption_in_thumbview', 1),
        array(
            'Afficher le nombre de commentaires sous les vignettes', 'display_comment_count', 1),
        array(
            'Classement par défaut des images', 'default_sort_order', 3),
        array(
            'Nombre minimum de votes nécessaires pour qu\'une image apparaisse dans la liste des images les mieux notées', 'min_votes_for_rating', 0),
        array(
        ...
        array(
            'Les informations relatives à l\'image sont affichées par défaut', 'display_pic_info', 1),
        array(
        ...
        array(
            'Afficher le négatif', 'display_film_strip', 1),
        array(
            'Nombre d\'images par négatif', 'max_film_strip_items', 0),
        array(
...
//'Pictures and thumbnails settings',
        ...
        array(
            'Qualité pour les fichiers JPG', 'jpeg_qual', 0),
        array(
        ...
        array(
            'Créer des images intermédiaires', 'make_intermediate', 1),
        array(
            'Largeur ou hauteur maximale pour une image intermédiaire <strong>*</strong>', 'picture_width', 0),
        array(
            'Poids max des images à uploader (Ko)', 'max_upl_size', 0),
        array(
            'Longueur ou hauteur maximale pour les images uploadées (en pixels)', 'max_upl_width_height', 0), 
        // 'User settings',
        'Paramètres Utilisateurs',
        array(
            'Autoriser de nouvelles inscriptions', 'allow_user_registration', 1),
        array(
            'L\'inscription d\'un nouvel utilisateur doit être validée', 'reg_requires_valid_email', 1),
        array(
            'Autoriser deux utilisateurs à avoir le même e-mail', 'allow_duplicate_emails_addr', 1),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Afficher l\'icône des albums privés aux utilisateurs non indentifiés', 'show_private', 1),
        array(
            'Caratères interdits dans les noms de fichiers', 'forbiden_fname_char', 0),
        array(
            'Extensions de fichiers acceptées pour les images à uploader', 'allowed_file_extensions', 0),
        array(
            'Méthode utilisée pour redimensionner les images', 'thumb_method', 2),
        array(
            'Chemin vers l\'utilitaire de conversion ImageMagick (exemple : /usr/bin/X11/)', 'impath', 0),
        array(
            'Type d\'images autorisées (valide seulement pour ImageMagick)', 'allowed_img_types', 0),
        array(
        ...
        array(
            'Répertoire de stockage de l\'album <strong>*</strong>', 'fullpath', 0),
        array(
            'Répertoire pour les images des utilisateurs <strong>*</strong>', 'userpics', 0),
        array(
            'Préfixe des images intermédiares <strong>*</strong>', 'normal_pfx', 0),
        array(
            'Préfixe pour les vignettes <strong>*</strong>', 'thumb_pfx', 0),
        array(
            'Mode par défaut des répertoires', 'default_dir_mode', 0),
        array(
            'Mode par défaut des images', 'default_file_mode', 0),
        array(
        ...
        array(
            'Nom du cookie utilisé par le script', 'cookie_name', 0),
        array(
            'Chemin du cookie utilisé par le script', 'cookie_path', 0),
        array(
            'Encodage des caractères', 'charset', 4), 
...
// File delete.php
// ------------------------------------------------------------------------- //
if (defined('DELETE_PHP')) $lang_delete_php = array('caption' => 'Légende',
...
if (defined('DISPLAYIMAGE_PHP')) {
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Cliquez sur l\'image pour fermer la fenêtre',
        );
} 
// ------------------------------------------------------------------------- //
// File ecard.php
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Nom du groupe',
        ...
        'note1' => '<strong>(1)</strong> Les uploads dans un album public doivent être approuvés par un administrateur',
        'note2' => '<strong>(2)</strong> Les uploads dans un album qui appartient à l\'utilisateur doivent être approuvés par un admin',
        'notes' => 'Remarques'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_list_categories = array('home' => 'Accueil',
        'stat1' => '<strong>[pictures]</strong> photos dans <strong>[albums]</strong> albums et <strong>[cat]</strong> catégories avec <strong>[comments]</strong> commentaires affichées <strong>[views]</strong> fois',
        'stat2' => '<strong>[pictures]</strong> photos dans <strong>[albums]</strong> albums affichées <strong>[views]</strong> times',
        'xx_s_gallery' => '%s\'s Galerie',
        'stat3' => '<strong>[pictures]</strong> photos dans <strong>[albums]</strong> albums avec <strong>[comments]</strong> commentaires affichées <strong>[views]</strong> fois'
        );
...
// File modifyalb.php
// ------------------------------------------------------------------------- //
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array('upd_alb_n' => 'Mettre à jour l\'album %s',
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Vous aviez déjà noté cette photo',
...
// File reviewcom.php
// ------------------------------------------------------------------------- //
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array('title' => 'Vérifier les commentaires',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Rechercher les nouvelles photos',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : signifie que l\'image a bien été mise en ligne' . '<li><strong>DP</strong> : signifie que la photo existe déjà dans la base de données' . '<li><strong>PB</strong> : signifie que la photo n\'a pas pu être ajoutée, vérifiez votre configuration et les permissions des répertoires dans lesquels les images se trouvent' . '<li>Si les signes OK, DP, PB n\'apparaissent pas, cliquez sur l\'image cassée afin de voir le message d\'erreur généré par PHP' . '<li>Si votre browser cesse d\'effectuer la tâche (timeout), cliquez sur le bouton actualiser' . '</ul>',
...
// File usermgr.php
// ------------------------------------------------------------------------- //
if (defined('USERMGR_PHP')) $lang_usermgr_php = array('title' => 'Gérer les utilisateurs',
        'name_a' => 'Nom ascendant',
        'name_d' => 'Nom descendant',
        ...
        'user_occ' => 'Activité de l\'utilisateur',
        );
// ------------------------------------------------------------------------- //
// File util.php
// ------------------------------------------------------------------------- //
