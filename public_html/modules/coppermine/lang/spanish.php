...
$lang_errors = array('access_denied' => 'No tienes permisos para acceder a esta página.',
...
$lang_cat_list = array('category' => 'Categoría',
    'albums' => 'Albums',
    'pictures' => 'Fotos',
    );

$lang_album_list = array('album_on_page' => '%d albums en %d página(s)'
    );
...
$lang_img_nav_bar = array('thumb_title' => 'Volver al índice del album',
...
// File catmgr.php
// ------------------------------------------------------------------------- //
if (defined('CATMGR_PHP')) $lang_catmgr_php = array('miss_param' => '¡Los parámetros requeridos para la operación: \'%s\' no han sido suministrados!',
...
// File config.php
// ------------------------------------------------------------------------- //
if (defined('CONFIG_PHP')) $lang_config_php = array('title' => 'Configuración',
...
if (defined('CONFIG_PHP'))
    $lang_config_data = array(
        ...
        array(
            'Nombre de la galería', 'gallery_name', 0),
        array(
            'Descripción de la galería', 'gallery_description', 0),
        array(
            'Correo electrónico del administrador', 'gallery_admin_email', 0),
        array(
...
// for postnuke change
        ...
        array(
            'Número de niveles de categorías a mostrar', 'subcat_level', 0),
        array(
            'Número de albums a mostrar', 'albums_per_page', 0),
        array(
            'Número de columnas en la lista de albums', 'album_list_cols', 0),
        array(
            'Tamaño de los thumbnails en pixels', 'alb_list_thumb_size', 0),
        array(
            'Contenido de la página principal', 'main_page_layout', 0),
        array(
            'Mostrar thumbnails de albums de primer nivel en categorías', 'first_level', 1), 
        // 'Thumbnail view',
        'Aspecto de la vista de Thumbnails',
        array(
            'Número de columnas en la página de thumbnails', 'thumbcols', 0),
        array(
            'Número de filas en la página de thumbnails', 'thumbrows', 0),
        array(
            'Máximo número de tabs a mostrar', 'max_tabs', 0),
        array(
            'Mostrar picture caption (además del título) debajo del thumbnail', 'caption_in_thumbview', 1),
        array(
            'Mostrar el número de comentarios debajo del thumbnail', 'display_comment_count', 1),
        array(
            'Orden por defecto de las fotos', 'default_sort_order', 3),
        array(
            'Minimo número de votos para que una foto aparezca el la lista de \'Más Valoradas\' list', 'min_votes_for_rating', 0),
        array(
        ...
        array(
            'Información de la foto visible por defecto', 'display_pic_info', 1),
        array(
        ...
        array(
            'Máxima longitud para la descripción de una foto', 'max_img_desc_length', 0),
        array(
            'Máximo número de caracteres en una palabra', 'max_com_wlength', 0),
        array(
            'Máximo número de lineas en un comentario', 'max_com_lines', 0),
        array(
            'Máxima longitud de un comentario', 'max_com_size', 0),
        array(
            'Mostrar tira de película', 'display_film_strip', 1),
        array(
            'Número de objetos en tira de película', 'max_film_strip_items', 0),
        array(
...
//'Pictures and thumbnails settings',
        ...
        array(
            'Máxima anchura o altura de los thumbnail <strong>*</strong>', 'thumb_width', 0),
        array(
            'Usar dimensión ( anchura o altura o Máximo para los thumbnail )<strong>*</strong>', 'thumb_use', 7),
        array(
            'Crear fotos de tamaño intermedio', 'make_intermediate', 1),
        array(
            'Máxima anchura o altura de las fotos de tamaño intermedio <strong>*</strong>', 'picture_width', 0),
        array(
            'Máximo tamaño de los fotos de usuarios por upload (KB)', 'max_upl_size', 0),
        array(
            'Máxima anchura o altura de las fotos de usuarios por upload (pixels)', 'max_upl_width_height', 0), 
        // 'User settings',
        'Configuración de usuarios',
        array(
            'Permitir el registro de nuevos usuarios', 'allow_user_registration', 1),
        array(
            'Registro de usuarios requiere verificación de email', 'reg_requires_valid_email', 1),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Método para el reescalado de fotos', 'thumb_method', 2),
        array(
            'Path de la utilidad ImageMagick (por ejemplo /usr/bin/X11/)', 'impath', 0),
        array(
            'Tipos de ficheros admitidos (solo válidos con ImageMagick)', 'allowed_img_types', 0),
        array(
        ...
        array(
            'Prefijo para las fotos de tamaño intermedio <strong>*</strong>', 'normal_pfx', 0),
        array(
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => '¿Estás seguro de querer BORRAR esta foto? \\nLos comentarios serán también borrados.',
    ...
    $lang_picinfo = array('title' => 'Información de la foto',
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'Enviar foto a un amigo',
        'invalid_email' => '<strong>Atención</strong> : ¡dirección e-mail incorrecta!',
...
// File editpics.php
// ------------------------------------------------------------------------- //
if (defined('EDITPICS_PHP')) $lang_editpics_php = array('pic_info' => 'Información',
        'album' => 'Album',
        'title' => 'Título',
        'desc' => 'Descripción',
        'keywords' => 'Keywords',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Nombre del grupo',
        ...
        'note1' => '<strong>(1)</strong> Añadir fotos en un album público requerirá aprobación de los administradores',
        'note2' => '<strong>(2)</strong> Añadir fotos en un album que pertenece al asuario requerirá aprobación de los administradores',
        'notes' => 'Notas'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_album_admin_menu = array('confirm_delete' => '¿Estás seguro de querer BORRAR este album ? \\nTodas las fotos y comentarios serán también borrados.',
        'delete' => 'BORRAR',
        'modify' => 'MODIFICAR',
        'edit_pics' => 'EDITAR FOTOS',
        );
    ...
    $lang_list_categories = array('home' => 'Home',
        'stat1' => '<strong>[pictures]</strong> fotos en <strong>[albums]</strong> albums y <strong>[cat]</strong> categorías con <strong>[comments]</strong> comentarios, vistas <strong>[views]</strong> veces',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Buscar nuevas fotos',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : significa que la foto fue añadida sin problemas' . '<li><strong>DP</strong> : significa que la foto es un duplicado y ya existe en la base de datos' . '<li><strong>PB</strong> : significa que la foto no puede ser añadida, por favor comprueba la configaración y los permisos de los directorios donde están las fotos' . '<li>Si los iconos OK, DP, PB no aparecen, pulsa sobre el icono de imagen no cargada para ver el error producido por PHP' . '<li>Si el navegador produce un timeout, pulsa el icono de Actualizar' . '</ul>',
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array('title' => 'Administrar usuarios',
        ...
        'user_occ' => 'Ocupación del usuario',
        );
// ------------------------------------------------------------------------- //
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Cambiar tamaño a las fotos',
