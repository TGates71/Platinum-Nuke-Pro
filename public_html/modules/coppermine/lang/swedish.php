...
$lang_thumb_view = array('date' => 'DATUM', 
    ...
    'rating' => 'VÄRDERING', // new in cpg1.2.0nuke
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array('alb_need_name' => 'Album måste namnges!',
        ...
        'confirm_delete1' => 'Är du säker på att du vill radera detta album?',
...
// for postnuke change
        ...
        array(
            'Bildinfo visa favvo albumlänk', 'picinfo_display_favorites', '1'), // new in cpg1.2.0nuke
