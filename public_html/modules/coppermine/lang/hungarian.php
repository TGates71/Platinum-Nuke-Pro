...
if (defined('CONFIG_PHP'))
    $lang_config_data = array(
        ...
        array(
            'Képtár adminisztrátor email címe', 'gallery_admin_email', 0),
        array(
...
//'Pictures and thumbnails settings',
        ...
        array(
            'Ikonok maximális mérete <strong>*</strong>', 'thumb_width', 0),
        array(
            'Méretek használata (ikonok szélessége, magassága, vagy maximális mérete)<strong>*</strong>', 'thumb_use', 7),
        array(
            'Közbensõ méretû kép generálása', 'make_intermediate', 1),
        array(
            'Közbensõ méretû képmaximális szélessége ésmagassága <strong>*</strong>', 'picture_width', 0),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Album elérési útvonala <strong>*</strong>', 'fullpath', 0),
        array(
            'Felhasználói képek elérési útvonala <strong>*</strong>', 'userpics', 0),
        array(
            'Középméretezett képek elõtagja <strong>*</strong>', 'normal_pfx', 0),
        array(
            'Ikonfájlok elõtagja <strong>*</strong>', 'thumb_pfx', 0),
        array(
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'E-képeslap küldése',
        'invalid_email' => '<strong>Figyelmeztetés</strong> : érvénytelen e-mail cím!',
...
// File groupmgr.php
// ------------------------------------------------------------------------- //
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Csoport megnevezése',
        ...
        'note1' => '<strong>(1)</strong> A nyilvános albumba történõ feltöltés adminisztrátori jóváhagyást igényel',
        'note2' => '<strong>(2)</strong> A felhasználó albumába történõ feltöltés adminisztrátori jóváhagyást igényel',
        'notes' => 'Megjegyzések'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    $lang_index_php = array('welcome' => 'Üdvözöllek!'
        );

    $lang_album_admin_menu = array('confirm_delete' => 'Biztos törölni akarod az albumot? \\nMinden kép és hozzászólás is törlõdik!',
        'delete' => 'TÖRLÉS',
    ...
    $lang_list_categories = array('home' => 'Home',
        'stat1' => '<strong>[pictures]</strong> kép <strong>[albums]</strong> albumban és <strong>[cat]</strong> kategóriában <strong>[comments]</strong> hozzászólással, megtekintések száma: <strong>[views]</strong>',
        'stat2' => '<strong>[pictures]</strong> kép <strong>[albums]</strong> albumban, megtekintések száma: <strong>[views]</strong>',
        'xx_s_gallery' => '%s képtára',
        'stat3' => '<strong>[pictures]</strong> kép <strong>[albums]</strong> albumban <strong>[comments]</strong> hozzászólással, megtekintések száma: <strong>[views]</strong>'
        );

    $lang_list_users = array('user_list' => 'Felhasználók listája',
        'no_user_gal' => 'Nincs felhasználó a képtárban',
        'n_albums' => '%s album(ok)',
        'n_pics' => '%s kép(ek)'
        );

    $lang_list_albums = array('n_pictures' => '%s kép',
...
// File modifyalb.php
// ------------------------------------------------------------------------- //
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array('upd_alb_n' => '%s album módosítása ',
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Sajnálom, de már osztályoztad ezt a képet',
...
EOT;
    ...
    $lang_register_php = array('page_title' => 'Felhasználó regisztráció',
...
// File reviewcom.php
// ------------------------------------------------------------------------- //
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array('title' => 'Hozzászólások megtekintése',
...
// if (defined('SEARCH_PHP'))
    $lang_search_php = array(0 => 'Keresés a képtárban',
        );
// ------------------------------------------------------------------------- //
// File searchnew.php
// ------------------------------------------------------------------------- //
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Új kép keresése',
        ...
        'target_album' => '<strong>Adja hozzá a </strong>"%s"<strong> könyvtárból a képeket a </strong>%s albumhoz',
        'folder' => 'Könyvtár',
        'image' => 'Kép',
        'album' => 'Album',
        'result' => 'Eredmény',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : azt jelenti, hogy a kép hozzáadása sikeres volt' . '<li><strong>DP</strong> : azt jelenti, hogy a kép már az adatbázisban volt' . '<li><strong>PB</strong> : azt jelenti, hogy a kép nem volt hozzáadható, ellenõrizd a konfigurációt és a képeket tartalmazó könyvtárak jogosultságait ' . '<li>Ha az OK, DP, PB \'jelek\' nem láthatók, klikkelj a hibás képre a PHP hibaüzenetének megjelenítéséhez' . '<li>Ha a browser leidõzített, nyomja meg a frissítés gombot' . '</ul>',
...
// File upload.php
// ------------------------------------------------------------------------- //
if (defined('UPLOAD_PHP')) $lang_upload_php = array('title' => 'Kép feltöltése',
...
// File usermgr.php
// ------------------------------------------------------------------------- //
if (defined('USERMGR_PHP')) $lang_usermgr_php = array('title' => 'Felhasználók menedzselése',
        'name_a' => 'Név növekvõ',
        'name_d' => 'Név csökkenõ',
        ...
        'user_from' => 'Felhasználó lakhelye',
        'user_interests' => 'Felhasználó érdeklõdési köre',
        'user_occ' => 'Felhasználó foglalkozása',
        );
// ------------------------------------------------------------------------- //
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Képek átméretezése',
