...
// File theme.php
// ------------------------------------------------------------------------- //
$lang_main_menu = array('alb_list_title' => 'Gå til albumlisten',
...
$lang_album_list = array('album_on_page' => '%d album på %d sider'
    );
...
// File albmgr.php
// ------------------------------------------------------------------------- //
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array('alb_need_name' => 'Album må ha et navn!',
...
// File catmgr.php
// ------------------------------------------------------------------------- //
if (defined('CATMGR_PHP')) $lang_catmgr_php = array('miss_param' => 'Obligatorisk paramenter ved \'%s\'operasjonen ble ikke utført!',
...
// for postnuke change
        ...
        'Album liste visning',
        array(
            'Bredde på hoved tabell (piksler eller %)', 'main_table_width', 0),
        array(
        ...
        array(
            'Størrelse på miniatyrbilde i piksler', 'alb_list_thumb_size', 0),
        array(
            'Innholdet på hovedsiden', 'main_page_layout', 0),
        array(
            'Vis miniatyrbilder fra første nivå i kategorier', 'first_level', 1), 
        // 'Thumbnail view',
        'Miniatyrbilde',
        array(
            'Antall kolonner på siden med miniatyrbilder', 'thumbcols', 0),
        array(
            'Antall rader på siden med miniatyrbilder', 'thumbrows', 0),
        array(
            'Maks antall miniatyrbilder på hver side', 'max_tabs', 0),
        array(
        ...
        array(
            'Standard sortering av bilderekkefølgen', 'default_sort_order', 3),
        array(
            'Minimum antall stemmer på bilde før visning i \'beste karakter\' listen', 'min_votes_for_rating', 0),
        array(
        ...
        array(
            'Maksimum lengde på bildebeskrivelse', 'max_img_desc_length', 0),
        array(
            'Maks lengde på hele ord', 'max_com_wlength', 0),
        array(
            'Maks linjer i en kommentar', 'max_com_lines', 0),
        array(
            'Maks lengde på en kommentar', 'max_com_size', 0),
        array(
...
//'Pictures and thumbnails settings',
        ...
        array(
            'Kvalitet på JPEG', 'jpeg_qual', 0),
        array(
            'Maks bredde og høyde på miniatyrbilder <strong>*</strong>', 'thumb_width', 0),
        array(
            'Bruk dimensjon ( bredde og høyde eller maks  )<strong>*</strong>', 'thumb_use', 7), // Get a "invalid error" message on configuration page
        array(
            'Opprett mellomliggende bilder', 'make_intermediate', 1),
        array(
            'Maks høyde eller bredde på mellomliggende bilde <strong>*</strong>', 'picture_width', 0),
        array(
            'Maks størrelse på bilder til opplasting (kB)', 'max_upl_size', 0),
        array(
            'Maks bredde eller høyde for bilder til opplasting (piksler)', 'max_upl_width_height', 0), 
        // 'User settings',
        'Instillinger for brukere',
        array(
            'Tillat at nye brukere kan registrere seg', 'allow_user_registration', 1),
        array(
            'Nye brukere må aktivere med e-post adresse', 'reg_requires_valid_email', 1),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Vis ikon for privat album til ikke pålogget bruker', 'show_private', 1),
        array(
            'Forbudte tegn i filnavn', 'forbiden_fname_char', 0),
        array(
            'Aksepter andre filtyper for opplasting', 'allowed_file_extensions', 0),
        array(
            'Metode for endring av størrelse på bilder', 'thumb_method', 2),
        array(
            'Adresse til ImageMagick / netpbm \'konverterings\' verktøy (eksempel /usr/bin/X11/)', 'impath', 0),
        array(
        ...
        array(
            'forhåndsvalgt navn på medlemsbilder <strong>*</strong>', 'normal_pfx', 0),
        array(
            'fårhåndsvalgt navn på miniatyrbilder <strong>*</strong>', 'thumb_pfx', 0),
        array(
            'Standard tilstand på mapper', 'default_dir_mode', 0),
        array(
            'Standard tilstand på bilder', 'default_file_mode', 0),
        array(
        ...
        array(
            'Navnet på den cookie brukt av dette systemet', 'cookie_name', 0),
        array(
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Er du sikker på at du vil slette dette bildet? \\nKommentarer bilr også slettet.',
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Klikk på bildet for å lukke',
        );
} 
// ------------------------------------------------------------------------- //
// File ecard.php
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Gruppenavn',
        ...
        'note2' => '<strong>(2)</strong> Opplastinger i privat album som tilhører brukeren krever administrators godkjennelse',
        'notes' => 'Notes'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_album_admin_menu = array('confirm_delete' => 'Er du sikker på at du vil slette dette albumet? \\nAlle bilder og kommentarer vil også bli slettet.',
        'delete' => 'SLETT',
        'modify' => 'REDIGER',
        'edit_pics' => 'REDIGER BILDER',
        );
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Beklager, men du har allerede stemt på dette bildet',
...
// File reviewcom.php
// ------------------------------------------------------------------------- //
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array('title' => 'Overblikk på kommentarer',
...
// if (defined('SEARCH_PHP'))
    $lang_search_php = array(0 => 'Søk i bilder',
        );
// ------------------------------------------------------------------------- //
// File searchnew.php
// ------------------------------------------------------------------------- //
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Søk i nye bilder',
...
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Reduser størrelsen på bilder',
