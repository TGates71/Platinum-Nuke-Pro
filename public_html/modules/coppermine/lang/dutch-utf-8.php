...
/*******************************************************************************/
define('PIC_VIEWS', 'Bekeken');
define('PIC_VOTES', 'Stemmen');
define('PIC_COMMENTS', 'Commentaren');
...
$lang_meta_album_names = array('random' => 'Willekeurige foto\'s',
...
$lang_errors = array('access_denied' => 'Je hebt geen toestemming om deze pagina te bezoeken.',
    ...
    'not_with_udb' => 'Deze functie is uitgeschakeld in Coppermine omdat het ge�ntegreerd is met forum software. Wat je tracht te doen is of niet ondersteund in deze configuratie, of de functie zal afgehandeld moeten worden door de forum software.',
...
// File theme.php
// ------------------------------------------------------------------------- //
$lang_main_menu = array('alb_list_title' => 'Ga naar de album lijst',
...
$lang_gallery_admin_menu = array('upl_app_lnk' => 'Upload toestemming',
...
$lang_user_admin_menu = array('albmgr_lnk' => 'Creëer/sorteer albums',
...
$lang_album_list = array('album_on_page' => '%d album(s) op %d pagina(\'s)'
    );
...
$lang_thumb_view = array('date' => 'DATUM', 
    ...
    'sort_ra' => 'Sorteer op mening oplopend', // new in cpg1.2.0nuke
    'sort_rd' => 'Sorteer op mening aflopend', // new in cpg1.2.0nuke
    'rating' => 'MENING', // new in cpg1.2.0nuke
    'sort_title' => 'Sorteer foto\'s op:', // new in cpg1.2.0nuke
    );

$lang_img_nav_bar = array('thumb_title' => 'Terug naar de thumbnail pagina',
    'pic_info_title' => 'Toon/verberg foto informatie',
    'slideshow_title' => 'Diashow',
    'slideshow_disabled' => 'e-cards is gedeactiveerd', // new in cpg1.2.0nuke
    ...
    'pic_pos' => 'Foto %s / %s',
    'no_more_images' => 'Er zijn niet meer plaatjes in deze gallerei', // new in cpg1.2.0nuke
    'no_less_images' => 'Dit is het plaatje in de gallerei', // new in cpg1.2.0nuke
    );

$lang_rate_pic = array('rate_this_pic' => 'Beoordeel deze foto ',
...
$lang_display_thumbnails = array('filename' => 'Bestandsnaam : ',
    'filesize' => 'Bestandsgrootte : ',
    'dimensions' => 'Afmetingen : ',
    'date_added' => 'Datum toegevoegd : '
    );

$lang_get_pic_data = array('n_comments' => '%s commentaren',
    'n_views' => '%s x bekeken',
    'n_votes' => '(%s stemmen)'
    );
// ------------------------------------------------------------------------- //
...
// ------------------------------------------------------------------------- //
if (defined('SMILIES_PHP')) $lang_smilies_inc_php = array('Exclamation' => 'Uitroepteken',
        'Question' => 'Vraag',
...
// File admin.php
// ------------------------------------------------------------------------- //
if (defined('ADMIN_PHP')) $lang_admin_php = array(0 => 'Verlaten admin-modus',
        1 => 'Admin-modus geactiveerd'
        );
// ------------------------------------------------------------------------- //
// File albmgr.php
// ------------------------------------------------------------------------- //
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array('alb_need_name' => 'Albums moeten een naam hebben !',
...
// File catmgr.php -
// ------------------------------------------------------------------------- //
if (defined('CATMGR_PHP')) $lang_catmgr_php = array('miss_param' => 'Vereiste parameters voor \'%s\'bewerking niet gegeven !',
...
// File config.php
// ------------------------------------------------------------------------- //
if (defined('CONFIG_PHP')) $lang_config_php = array('title' => 'Configuratie',
...
$lang_config_data = array(
	'Algemene instellingen',
        ...
        array('Adres naar nuke map vb http://www.mysite.tld/html', 'ecards_more_pic_target', 0),
        array('Taal', 'lang', 5),
// for postnuke change
        array('Thema', 'cpgtheme', 6),
        array('Pagina Specifieke Titels ipv >Coppermine', 'nice_titles', 1),
        array('Toon rechter blokken', 'right_blocks', 1),
...
// 'Pictures and thumbnails settings',
        ...
        array('Maximale breedte of hoogte van een thumbnail <strong>*</strong>', 'thumb_width', 0),
        array('Maximale afmeting van een thumbnail <strong>*</strong>', 'thumb_width', 0),
        array('Gebruik afmeting  (breedte of hoogte verhouding van thumbnail) <strong>*</strong>', 'thumb_use', 7),
        array('Creëer tussen foto\'s', 'make_intermediate', 1),
        array('Maximale breedte of hoogte van tussen foto\'s <strong>*</strong>', 'picture_width', 0),
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array('De album map <strong>*</strong>', 'fullpath', 0),
        array('De map voor gebruikers foto\'s <strong>*</strong>', 'userpics', 0),
        array('De prefix voor tussen foto\'s <strong>*</strong>', 'normal_pfx', 0),
        array('De prefix voor thumbnails <strong>*</strong>', 'thumb_pfx', 0),
        ...
        array('Aanzetten geadvanceerde debug modus', 'advanced_debug_mode', 1), // new in cpg1.2.0nuke
        array('Toon Coppermine Update Waarschuwing aan Admin', 'showupdate', 1), // new 1.2.2
...
// File db_input.php
// ------------------------------------------------------------------------- //
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array('empty_name_or_com' => 'Je moet je naam en commentaar ingeven.',
...
// File delete.php
// ------------------------------------------------------------------------- //
if (defined('DELETE_PHP')) $lang_delete_php = array('caption' => 'Koptekst',
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Weet je het zeker dat je deze foto wilt VERWIJDEREN ? \\nCommentaar wordt ook verwijderd.',
        ...
        'edit_pic' => 'BEWERK FOTO', // new in cpg1.2.0nuke
        );

    $lang_picinfo = array('title' => 'Foto informatie',
        ...
        'iptcKeywords' => 'IPTC Trefwoorden', // new in cpg1.2.0nuke
        'iptcCategory' => 'IPTC Categorie', // new in cpg1.2.0nuke
        'iptcSubCategories' => 'IPTC Sub Categorie�n', // new in cpg1.2.0nuke
        'bookmark_page' => 'Bookmark Plaatje', // new in cpg1.2.0nuke
        );
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Klik op de foto om dit window te sluiten',
        );
} 
// ------------------------------------------------------------------------- //
// File ecard.php
// ------------------------------------------------------------------------- //
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'Stuur een e-card',
        'invalid_email' => '<strong>Waarschuwing</strong> : ongeldig e-mail adres !',
...
// File editpics.php
// ------------------------------------------------------------------------- //
if (defined('EDITPICS_PHP')) $lang_editpics_php = array('pic_info' => 'Foto&nbsp;info',
        'album' => 'Album',
        'title' => 'Titel',
        'desc' => 'Beschrijving',
        'keywords' => 'Sleutelwoorden',
...
// File groupmgr.php
// ------------------------------------------------------------------------- //
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Groepsnaam',
        ...
        'note1' => '<strong>(1)</strong> upload in een publiek album benodigd toesteming van de admin',
        'note2' => '<strong>(2)</strong> upload in een album welke behoort aan een gebruiker benodigd toestemming van de admin',
        'notes' => 'Notities'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    $lang_index_php = array('welcome' => 'Welkom !'
        );

    $lang_album_admin_menu = array('confirm_delete' => 'Weet je het zeker dat je dit album wilt VERWIJDEREN ? \\nAlle foto\\\'s en commentaren worden ook verwijderd.',
        'delete' => 'Verwijder',
    ...
    $lang_list_categories = array('home' => 'Home',
        'stat1' => '<strong>[pictures]</strong> foto\'s in <strong>[albums]</strong> albums en <strong>[cat]</strong> categorieën met <strong>[comments]</strong> commentaren en <strong>[views]</strong> keer bekeken',
        'stat2' => '<strong>[pictures]</strong> foto\'s in <strong>[albums]</strong> albums en <strong>[views]</strong> keer bekeken',
        'xx_s_gallery' => '%s\'s Galerij',
        'stat3' => '<strong>[pictures]</strong> foto\'s in <strong>[albums]</strong> albums met <strong>[comments]</strong> commentaren en <strong>[views]</strong> keer bekeken'
        );

    $lang_list_users = array('user_list' => 'Gebruikers lijst',
        'no_user_gal' => 'Er zijn geen gebruikers die toestemming hebben om albums te hebben.',
        'n_albums' => '%s album(s)',
        'n_pics' => '%s foto(\'s)'
        );

    $lang_list_albums = array('n_pictures' => '%s foto\'s',
...
// File modifyalb.php
// ------------------------------------------------------------------------- //
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array('upd_alb_n' => 'Pas album %s aan',
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Sorry, maar je hebt deze foto al beoordeeld',
...
EOT;
    ...
    $lang_register_php = array('page_title' => 'Gebruiker registratie',
...
// File reviewcom.php
// ------------------------------------------------------------------------- //
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array('title' => 'Beoordeel commentaar',
...
// if (defined('SEARCH_PHP'))
    $lang_search_php = array(0 => 'Doorzoek de foto collectie'
        );
// ------------------------------------------------------------------------- //
// File searchnew.php
// ------------------------------------------------------------------------- //
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Zoek nieuwe foto\'s',
        ...
        'target_album' => '<strong>Plaats foto\'s van &quot;</strong>%s<strong>&quot; in </strong>%s',
        'folder' => 'Folder',
        'image' => 'Foto',
        'album' => 'Album',
        'result' => 'Resultaat',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : betekent dat de foto succesvol toegevoegd is' . '<li><strong>DP</strong> : betekent dat de foto dubbel is en zich reeds in de database bevindt' . '<li><strong>PB</strong> : betekent dat de foto niet toegevoegd kon worden, controleer je configuratie en de permissies op mappen waar de foto\'s zich bevinden' . '<li>Als de OK, DP, PB \'tekens\' niet verschijnen klik dan op de verbroken foto om te kijken of er een PHP fout bericht gegeven wordt' . '<li>Indien je browser uittimed klik dan op de herlaad knop' . '</ul>'
        );
// ------------------------------------------------------------------------- //
// File thumbnails.php
// ------------------------------------------------------------------------- //
...
// File usermgr.php
// ------------------------------------------------------------------------- //
if (defined('USERMGR_PHP')) $lang_usermgr_php = array('title' => 'Gebruikers beheer',
        'name_a' => 'Naam oplopend',
        'name_d' => 'Naam aflopend',
        ...
        'user_loc' => 'Gebruiker locatie',
        'user_interests' => 'Gebruiker interesse',
        'user_occ' => 'Gebruiker beroep',
        );
// ------------------------------------------------------------------------- //
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Aanpassen afmetingen foto\'s',
