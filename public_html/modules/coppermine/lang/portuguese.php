...
//'Pictures and thumbnails settings',
        ...
        array(
            'Dimensão máxima de um thumbnail <strong>*</strong>', 'thumb_width', 0),
        ...
        array(
            'Largura máxima das fotos de tamanho intermédio <strong>*</strong>', 'picture_width', 0),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Directório base dos álbuns <strong>*</strong>', 'fullpath', 0),
        array(
            'Directório para as fotos submetidas pelos usuários <strong>*</strong>', 'userpics', 0),
        array(
            'Prefixo para as fotos de tamanho intermédio <strong>*</strong>', 'normal_pfx', 0),
        array(
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'Enviar foto a um amigo',
        'invalid_email' => '<strong>Atenção</strong> : Endereço e-mail incorrecto!',
...
// File editpics.php
// ------------------------------------------------------------------------- //
if (defined('EDITPICS_PHP')) $lang_editpics_php = array('pic_info' => 'Informação',
        'album' => 'Album',
        'title' => 'Título',
        'desc' => 'Descrição',
        'keywords' => 'Palavras chave',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Nome do grupo',
        ...
        'note1' => '<strong>(1)</strong> Adicionar fotos a um album público requer aprovação dos administradores',
        'note2' => '<strong>(2)</strong> Adicionar fotos a um album que pertence ao utilizador requer aprovação dos administradores',
        'notes' => 'Notas'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_list_categories = array('home' => 'Página Inicial',
        'stat1' => '<strong>[pictures]</strong> fotos em <strong>[albums]</strong> albuns e <strong>[cat]</strong> categorias com <strong>[comments]</strong> comentários, visualizadas <strong>[views]</strong> vezes',
        ...
        'stat3' => '<strong>[pictures]</strong> fotos em <strong>[albums]</strong> albuns com <strong>[comments]</strong> comentários, visualizadas <strong>[views]</strong> vezes'
        );
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Procurar novas fotos',
        ...
        'target_album' => '<strong>Colocar as fotos do directório &quot;</strong>%s<strong>&quot; no album </strong>%s',
        'folder' => 'Pasta',
        'image' => 'Foto',
        'album' => 'Album',
        'result' => 'Resultado',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : significa que a foto foi adicionada sem problemas' . '<li><strong>DP</strong> : significa que a foto é um duplicado e já existe na base de dados' . '<li><strong>PB</strong> : significa que a foto não pode ser adicionada, por favor verifica a configuração e as permissões dos directórios onde estão as fotos' . '<li>Se os icones OK, DP, PB não aparecerem, prime sobre o icone de imagem não carregada para ver o erro produzido pelo PHP' . '<li>Se o browser faz um timeout, prime o ícone Actualizar' . '</ul>',
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array('title' => 'Administrar utilizadores',
        ...
        'user_oc' => 'Ocupação do utilizador',
        );
// ------------------------------------------------------------------------- //
// File util.php
// ------------------------------------------------------------------------- //
