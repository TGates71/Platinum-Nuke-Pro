...
$lang_errors = array('access_denied' => 'Non puoi accedere a questa pagina.',
    ...
    'members_only' => 'Questa funzione è solo per utenti registrati, registrati.', // changed in cpg1.2.0nuke
    'mustbe_god' => 'Questa funzione è solo per per l\'Amministratore. Devi entrar come superadmin, account god per accedere a questa funzione'
    );
// ------------------------------------------------------------------------- //
// File theme.php
// ------------------------------------------------------------------------- //
...
$lang_img_nav_bar = array('thumb_title' => 'Torna alle miniature',
    ...
    'no_less_images' => 'Questa è la prima immagine della galleria', // new in cpg1.2.0nuke
    );
...
// File admin.php
// ------------------------------------------------------------------------- //
if (defined('ADMIN_PHP')) $lang_admin_php = array(0 => 'Lascio la modalità admin...',
...
if (defined('CONFIG_PHP')) $lang_config_data = array('Impostazioni generali',
        ...
        array('Indirizzo della directory nuke, cioè http://www.mysite.tld/html', 'ecards_more_pic_target', 0), // new in cpg1.2.0nuke
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array('Attiva modalità debug avanzato', 'advanced_debug_mode', 1), // new in cpg1.2.0nuke
array(
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Spiacenti, hai già votato questa immagine',
...
Gli amministratori di <strong>{SITE_NAME}</strong> rimuoveranno tutto quello che non sarà ritenuto compatibile con le finalità ed il decoro del sito.Ti chiediamo di rispettare il lavoro degli altri utenti e del webmaster.<br />
<br />
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Cerca nuove immagini',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : immagine aggiunta con successo' . '<li><strong>DP</strong> : immagine già presente nel database' . '<li><strong>PB</strong> : immagine non aggiunta a causa della errata configurazione del server o del chmod delle cartelle' . '<li>Se OK, DP, PB non appaiono clicca sulla immagine per vedere quale errore è stato causato dal PHP' . '<li>Se il tuo browser va in timeout, premi il tasto Aggiorna' . '</ul>',
