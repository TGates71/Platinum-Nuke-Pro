...
$lang_translation_info = array(
    ...
    'trans_date' => '2003-11-04', // the date the translation was created / last modified
    );
...
if (defined('CONFIG_PHP')) $lang_config_data = array('Setting Umum',
        array(
            'Nama Galeri', 'gallery_name', 0),
        array(
            'Keterangan', 'gallery_description', 0),
        array(
            'Email admin galeri', 'gallery_admin_email', 0),
        array(
...
// for postnuke change
        ...
        array(
            'Lebar tabel utama (piksel atau %)', 'main_table_width', 0),
        array(
            'Jumlah level kategori yang ditampilkan', 'subcat_level', 0),
        array(
            'Jumlah album yang ditampilkan', 'albums_per_page', 0),
        array(
            'Jumlah kolom di daftar album', 'album_list_cols', 0),
        array(
            'Ukuran thumbnail dalam piksel', 'alb_list_thumb_size', 0),
        array(
            'Tampilan halaman utama', 'main_page_layout', 0),
        array(
            'Tampilkan thumbnail album level pertama dalam kategori', 'first_level', 1),

        'Tampilan thumbnail',
        array(
            'Jumlah kolom di halaman thumbnail', 'thumbcols', 0),
        array(
            'Jumlah baris di halaman thumbnail', 'thumbrows', 0),
        array(
            'Jumlah maksimum tampilan tab', 'max_tabs', 0),
        array(
            'Tampilkan keterangan foto (sebagai tambahan judul) di bawah thumbnail', 'caption_in_thumbview', 1),
        array(
            'Tampilkan jumlah komentar di bawah thumbnail', 'display_comment_count', 1),
        array(
            'Urutan foto default', 'default_sort_order', 3),
        array(
            'Jumlah suara minimal bagi foto untuk tampil di daftar \'nilai tertinggi\'', 'min_votes_for_rating', 0),
        array(
            'Tag Alt dan title thumbnail tampilkan judul dan keyword (bukan picinfo)', 'seo_alts', 1), // new in cpg1.2.0nuke
        'Tampilan foto &amp; setting komentar',
        array(
            'Lebar table tampilan foto (piksel atau %)', 'picture_table_width', 0),
        array(
            'Informasi foto secara default tampak', 'display_pic_info', 1),
        array(
            'Saring kata-kata buruk dalam komentar', 'filter_bad_words', 1),
        array(
            'Izinkan smilies dalam komentar', 'enable_smilies', 1),
        array(
            'Izinkan lebih dari satu kali komentar secara berturut-turut oleh user', 'disable_flood_protection', 1), // new in cpg1.2.0nuke
        array(
            'Email ke admin situs saat ada kiriman komentar' , 'comment_email_notification', 1), // new in cpg1.2.0nuke
        array(
            'Panjang maksimum keterangan foto', 'max_img_desc_length', 0),
        array(
            'Jumlah karakter makimum dalam kata', 'max_com_wlength', 0),
        array(
            'Jumlah baris maksimum dalam komentar', 'max_com_lines', 0),
        array(
            'Panjang maksimum komentar', 'max_com_size', 0),
        array(
            'Tampilkan film strip', 'display_film_strip', 1),
        array(
            'Jumlah item dalam film strip', 'max_film_strip_items', 0),
        array(
...
// 'Pictures and thumbnails settings',
        ...
        array(
            'Kualitas file JPEG', 'jpeg_qual', 0),
        array(
            'Dimensi thumbnail maksimum <strong>*</strong>', 'thumb_width', 0),
        array(
            'Gunakan dimensi ( lebar atau tinggi atau perbandingan maksimum untuk thumbnail )<strong>*</strong>', 'thumb_use', 7),

        array(
            'Buat foto antara', 'make_intermediate', 1),
        array(
            'Lebar atau tinggi maksimum foto antara <strong>*</strong>', 'picture_width', 0),
        array(
            'Besar maksimum foto yang diupload (KB)', 'max_upl_size', 0),
        array(
            'Lebar atau tinggi maksimum foto yang diupload (piksel)', 'max_upl_width_height', 0),

        'Setting user',
        array(
            'Izinkan pendaftaran user baru', 'allow_user_registration', 1),
        array(
            'Pendaftaran menggunakan pengesahan melalui email', 'reg_requires_valid_email', 1),
        array(
            'Izinkan dua user untuk memiliki alamat email yang sama', 'allow_duplicate_emails_addr', 1),
        array(
            'User bisa memiliki album pribadi', 'allow_private_albums', 1),
array('Show Users avatar instead of private album picture', 'avatar_private_album', 1),
//'Custom fields for image description (leave blank if unused)',

        'Field tambahan untuk keterangan image (kosongkan jika tidak digunakan)',
        array(
            'Nama field 1', 'user_field1_name', 0),
        array(
            'Nama field 2', 'user_field2_name', 0),
        array(
            'Nama field 3', 'user_field3_name', 0),
        array(
            'Nama field 4', 'user_field4_name', 0),

        'Setting tambahan foto dan thumbnail',
        array(
            'Tampilkan ikon album pribadi untuk user yang tidak login', 'show_private', 1),
        array(
            'Karakter yang tidak diizinkan dalam nama file', 'forbiden_fname_char', 0),
        array(
            'Ekstensi file yang diizinkan untuk foto yang diupload', 'allowed_file_extensions', 0),
        array(
            'Metode pengubah ukuran image', 'thumb_method', 2),
        array(
            'Path utiliti \'konversi\' ImageMagick (mis. /usr/bin/X11/)', 'impath', 0),
        array(
            'Tipe image yang diizinkan (hanya berlaku untuk ImageMagick)', 'allowed_img_types', 0),
        array(
            'Opsi Command line untuk ImageMagick', 'im_options', 0),
        array(
            'Baca data EXIF dalam file JPEG', 'read_exif_data', 1),
        array(
            'Baca data IPTC dalam file JPEG', 'read_iptc_data', 1), // new in cpg1.2.0nuke
        array(
            'Direktori album <strong>*</strong>', 'fullpath', 0),
        array(
            'Direktori foto user <strong>*</strong>', 'userpics', 0),
        array(
            'Prefiks untuk foto antara <strong>*</strong>', 'normal_pfx', 0),
        array(
            'Prefiks untuk thumbnail <strong>*</strong>', 'thumb_pfx', 0),
        array(
            'Mode default untuk direktori', 'default_dir_mode', 0),
        array(
            'Mode default untuk foto', 'default_file_mode', 0),
        array(
        ...
        array(
            'Nama cookie yang digunakan oleh skrip', 'cookie_name', 0),
        array(
            'Path cookie yang digunakan oleh skrip', 'cookie_path', 0),
        array(
            'Encoding Karakter', 'charset', 4),

        'Setting lain-lain',
        array(
            'Aktifkan mode debug', 'debug_mode', 1),
        array(
...
if (defined('DISPLAYIMAGE_PHP')) {
    ...
    $lang_picinfo = array('title' => 'Informasi foto',
        ...
        'Comment' => 'Komentar',
        'addFav' => 'Tambahkan ke Album Favorit',//different in 1.2.0nuke
        'addFavPhrase' => 'Favorit', // new in cpg1.2.0different in 1.2.0nuke
        'remFav' => 'Hapus dari Album Favorit',
