...
define('PIC_VIEWS', 'g&ouml;r&uuml;nt&uuml;leme');
define('PIC_VOTES', 'Oy');
define('PIC_COMMENTS', 'Yorum');
...
$lang_meta_album_names = array('random' => 'Rasgele resimler',
...
$lang_errors = array('access_denied' => 'Bu sayfayý g&ouml;r&uuml;nt&uuml;lemeye izniniz yok.',
...
// File theme.php
// ------------------------------------------------------------------------- //
$lang_main_menu = array('alb_list_title' => 'Alb&uuml;m listesine git',
...
$lang_gallery_admin_menu = array('upl_app_lnk' => 'Y&uuml;kleme izini',
...
$lang_user_admin_menu = array('albmgr_lnk' => 'Oluþtur veya alb&uuml;mleri iste',
...
$lang_album_list = array('album_on_page' => '%d alb&uuml;m&uuml;n&uuml;z %d sayfadadýr'
    );

$lang_thumb_view = array('date' => 'TARÝH',
    'name' => 'DOSYA ADI',
    'title' => 'BAÞLIK',
...
$lang_img_nav_bar = array('thumb_title' => 'K&uuml;ç&uuml;k resim sayfasýna geri d&ouml;n',
...
$lang_rate_pic = array('rate_this_pic' => 'Bu resimi oylayýn ',
...
$lang_display_thumbnails = array('filename' => 'Dosya adý : ',
    'filesize' => 'Dosya boyutu : ',
    'dimensions' => 'Boyutlarý : ',
    'date_added' => 'Eklenme tarihi : '
    );

$lang_get_pic_data = array('n_comments' => '%s yorum',
...
// ------------------------------------------------------------------------- //
if (defined('SMILIES_PHP')) $lang_smilies_inc_php = array('Exclamation' => '&Uuml;nlem',
        'Question' => 'Soru',
...
// File admin.php
// ------------------------------------------------------------------------- //
if (defined('ADMIN_PHP')) $lang_admin_php = array(0 => 'Y&ouml;netici konumu kapatýlýyor...',
        1 => 'Y&ouml;netici konumu açýlýyor...',
        );
// ------------------------------------------------------------------------- //
// File albmgr.php
// ------------------------------------------------------------------------- //
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array('alb_need_name' => 'Alb&uuml;mleri isim vermelisiniz !',
...
// File catmgr.php
// ------------------------------------------------------------------------- //
if (defined('CATMGR_PHP')) $lang_catmgr_php = array('miss_param' => '\'%s\' için komutlar gerekli iþlem yapýlamadý !',
...
// File config.php
// ------------------------------------------------------------------------- //
if (defined('CONFIG_PHP')) $lang_config_php = array('title' => 'Seçenekler',
...
if (defined('CONFIG_PHP'))
    $lang_config_data = array(
        ...
        'Genel Seçenekler',
        array(
            'Galeri Ýsmi', 'gallery_name', 0),
        array(
            'Galeri Açýklamasý', 'gallery_description', 0),
        array(
            'Galeri Y&ouml;neticisi e-Posta', 'gallery_admin_email', 0),
        array(
            'Address to nuke folder ie http://www.mysite.tld/html', 'ecards_more_pic_target', 0),
        array(
            'Dil', 'lang', 5),
// for postnuke change
        array('Aray&uuml;z', 'cpgtheme', 6),
        array(
        ...
        array(
            'Ana tablonun geniþliði (piksel veya %)', 'main_table_width', 0),
        array(
            'G&ouml;sterilecek olan kategori d&uuml;zeylerinin sayýsý', 'subcat_level', 0),
        array(
            'G&ouml;sterilecek alb&uuml;mlerin sayýsý', 'albums_per_page', 0),
        array(
            'Alb&uuml;m listesi için s&uuml;tun sayýsý', 'album_list_cols', 0),
        array(
            'K&uuml;ç&uuml;k resimlerin boyutu piksel olarak', 'alb_list_thumb_size', 0),
        array(
            'Ana sayfanýn içeriði', 'main_page_layout', 0),
        array(
            'Birinci seviye albümlerin küçük resimlerini kategorilerde göster', 'first_level', 1), 
        // 'Thumbnail view',
        'K&uuml;ç&uuml;k resim g&ouml;r&uuml;nt&uuml;s&uuml;',
        array(
            'K&uuml;ç&uuml;k resim sayfasýndaki s&uuml;tun sayýsý', 'thumbcols', 0),
        array(
            'K&uuml;ç&uuml;k resim sayfasýndaki sýra sayýsý', 'thumbrows', 0),
        array(
            'En çok g&ouml;sterilecek etiket sayýsý', 'max_tabs', 0),
        array(
            'Resim manþet baþlýðýný k&uuml;ç&uuml;k resim sayfasýnda g&ouml;ster', 'caption_in_thumbview', 1),
        array(
            'K&uuml;ç&uuml;k resimlerin altýnda yorum sayýsýný g&ouml;r&uuml;nt&uuml;le', 'display_comment_count', 1),
        array(
            'Hazýr ayarlarý kullanarak resimleri sýrala', 'default_sort_order', 3),
        array(
            'Bir resmin \'top-rated\' listesine g&ouml;z&uuml;kebilmesi için almasý gerekn azami oy sayýsý', 'min_votes_for_rating', 0),
        array(
        ...
        array(
            'Resimlerin g&ouml;sterileceði tablonun geniþliði (piksel veya %)', 'picture_table_width', 0),
        array(
            'Resim bilgilerine g&ouml;ster', 'display_pic_info', 1),
        array(
            'K&uuml;f&uuml;rleri yorumlarda filtrele', 'filter_bad_words', 1),
        array(
            'Yorumlar da smiley kullanýmýna izin ver', 'enable_smilies', 1),
        array(
        ...
        array(
            'Bir resim açýklmasýnýn maksimum uzunluðu', 'max_img_desc_length', 0),
        array(
            'Bir kelime içindeki maksimum harf sayýsý', 'max_com_wlength', 0),
        array(
            'Bir yorum içindeki maksimum satýr sayýsý', 'max_com_lines', 0),
        array(
            'Bir yorumun maksimum uzunluðu', 'max_com_size', 0),
        array(
            'Film þeridi göster', 'display_film_strip', 1),
        array(
            'Film þeridindeki adet sayýsý', 'max_film_strip_items', 0),
        array(
...
//'Pictures and thumbnails settings',
        ...
        array(
            'JPEG dosyalarý için kalite ayarý', 'jpeg_qual', 0),
        array(
            'Küçük resmin en büyük boyutu <strong>*</strong>', 'thumb_width', 0),
        array(
            'Boyut kullan ( geniþlik veya yükseklik veya en büyük görünüþ küçük resimler için ) <strong>*</strong>', 'thumb_use', 7),
        array(
            'Ara resimleri yarat', 'make_intermediate', 1),
        array(
            'Bir ara resmin maksium geniþliði veya boyu <strong>*</strong>', 'picture_width', 0),
        array(
            'Y&uuml;klenecek olan resimler için maksimum boyut (KB)', 'max_upl_size', 0),
        array(
            'Y&uuml;klenecek olan resimler için makisum geniþlik veya boy (piksel)', 'max_upl_width_height', 0), 
        // 'User settings',
        'Kullanýcý seçenekleri',
        array(
            'Yeni kullanýcý kaydýna izin ver', 'allow_user_registration', 1),
        array(
            'Yeni kullanýcý kaydý için e-Posta onayýna ihtiyaç var', 'reg_requires_valid_email', 1),
        array(
            'Ýki kullanýcý ayný e-Posta adresine sahip olmasýna izin ver', 'allow_duplicate_emails_addr', 1),
        array(
            'Kullanýcýlarýn kiþisel galerileri olabilir', 'allow_private_albums', 1), 
        array('Show Users avatar instead of private album picture', 'avatar_private_album', 1),
//'Custom fields for image description (leave blank if unused)',
        'Resim açýklamalarý için &ouml;zel alanlar (eðer kullanýlmayacaksa boþ býrakýn)',
        array(
            'Alan 1 adý', 'user_field1_name', 0),
        array(
            'Alan 2 adý', 'user_field2_name', 0),
        array(
            'Alan 3 adý', 'user_field3_name', 0),
        array(
            'Alan 4 adý', 'user_field4_name', 0), 
        // 'Pictures and thumbnails advanced settings',
        'Resim ve k&uuml;ç&uuml;k resim geliþmiþ seçenekleri',
        array(
            'Çýkýþ yapmamýþ kullanýcýya özel resim ikonunu göster', 'show_private', 1),
        array(
            'Dosya isimlerinde karakterlere izin verme', 'forbiden_fname_char', 0),
        array(
            'Y&uuml;klenmiþ olan resimler için kabul edilen uzantýlar', 'allowed_file_extensions', 0),
        array(
            'Resimleri boyutlandýrmak için kullanýlan y&ouml;ntem', 'thumb_method', 2),
        array(
            'ImageMagick için yol (example /usr/bin/X11/)', 'impath', 0),
        array(
            'Kabul edilen resim tipleri (sadece ImageMagick için geçerli)', 'allowed_img_types', 0),
        array(
            'Komut satýr seçenekleri ImageMagick için', 'im_options', 0),
        array(
            'EXIF bilgisini oku JPEG dosyalarýnda', 'read_exif_data', 1),
        array(
            'ITPC bilgisini oku JPEG dosyalarýnda', 'read_itpc_data', 1),
        array(
            'Alb&uuml;m dizini <strong>*</strong>', 'fullpath', 0),
        array(
            'Kullanýcý resimleri için dizin <strong>*</strong>', 'userpics', 0),
        array(
            'Ara resimler için &ouml;nek <strong>*</strong>', 'normal_pfx', 0),
        array(
            'K&uuml;ç&uuml;k resimler için &ouml;nek <strong>*</strong>', 'thumb_pfx', 0),
        array(
            'Dizinler için hazýr ayar', 'default_dir_mode', 0),
        array(
            'Resimleri için hazýr ayar', 'default_file_mode', 0),
        array(
        ...
        array(
            'Program tarafýndan kullanýlan cookielerin adý', 'cookie_name', 0),
        array(
            'Program tarafýndan kullanýlan cookielerin dizin yolu', 'cookie_path', 0),
        array(
            'Karakter kodlama', 'charset', 4), 
        // 'Miscellaneous settings',
        'Diðer seçenekler',
        array(
            'Hata ç&ouml;z&uuml;mleme seçeneði aç', 'debug_mode', 1),
        array(
...
// File db_input.php
// ------------------------------------------------------------------------- //
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array('empty_name_or_com' => 'Adýnýzý ve bir yorum yazmanýz gerek',
...
// File delete.php
// ------------------------------------------------------------------------- //
if (defined('DELETE_PHP')) $lang_delete_php = array('caption' => 'Baþlýk',
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Bu resmi sileceðinizden emin misiniz ? \\nYorumlar da silinecektir.',
    ...
    $lang_picinfo = array('title' => 'Resim bilgileri',
        'Filename' => 'Dosya adý',
    ...
    $lang_display_comments = array('OK' => 'TAMAM',
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Bu pencereyi kapatmak için resime klikleyin',
        );
} 
// ------------------------------------------------------------------------- //
// File ecard.php
// ------------------------------------------------------------------------- //
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'Bir e-Kart yollayýn',
        'invalid_email' => '<strong>Dikkat</strong> : yanlýþ e-Posta adresi !',
...
// File editpics.php
// ------------------------------------------------------------------------- //
if (defined('EDITPICS_PHP')) $lang_editpics_php = array('pic_info' => 'Resim bilgileri',
        'album' => 'Alb&uuml;m',
        'title' => 'Baþlýk',
        'desc' => 'Açýklama',
...
// File groupmgr.php
// ------------------------------------------------------------------------- //
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Grup adý',
        ...
        'note1' => '<strong>(1)</strong> Kiþisel galeriye y&uuml;klenecek olan resimler y&ouml;netici tarafýndan onaylanmalý',
        'note2' => '<strong>(2)</strong> Kullanýcýya ait galeriye y&uuml;kleme yapmak için y&ouml;netici onayýna gerek',
        'notes' => 'Notlar'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    $lang_index_php = array('welcome' => 'Hoþgeldiniz !'
        );

    $lang_album_admin_menu = array('confirm_delete' => 'Bu alb&uuml;m&uuml; silmek istediðinizden emin misiniz ? \\nB&uuml;t&uuml;n resimler ve yorumlar da silinecektir.',
        'delete' => 'SÝL',
        'modify' => '&Ouml;ZELLÝKLER',
        'edit_pics' => 'RESÝMLERDE DEÐÝÞÝÝKLÝLK YAP',
        );

    $lang_list_categories = array('home' => 'Ana',
        'stat1' => '<strong>[pictures]</strong> resimler <strong>[albums]</strong> alb&uuml;mde ve <strong>[cat]</strong> kategoride, <strong>[comments]</strong> yorum <strong>[views]</strong> kere g&ouml;r&uuml;nt&uuml;lenmiþtir',
        'stat2' => '<strong>[pictures]</strong> resim <strong>[albums]</strong> alb&uuml;mde <strong>[views]</strong> kere g&ouml;r&uuml;nt&uuml;lenmiþtir',
        'xx_s_gallery' => '%s\ in Galerisi',
        'stat3' => '<strong>[pictures]</strong> resim <strong>[albums]</strong> alb&uuml;mde <strong>[comments]</strong> yorum <strong>[views]</strong> kere g&ouml;r&uuml;nt&uuml;lenmiþtir'
        );

    $lang_list_users = array('user_list' => 'Kullanýcý listesi',
        'no_user_gal' => 'Alb&uuml;m yaratma izni olan hiçbir kullanýcý yok',
        'n_albums' => '%s alb&uuml;m',
        'n_pics' => '%s resim'
        );

    $lang_list_albums = array('n_pictures' => '%s resim',
...
// File modifyalb.php
// ------------------------------------------------------------------------- //
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array('upd_alb_n' => 'Alb&uuml;m&uuml; g&uuml;ncelle %s',
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Bu resimi &ouml;nceden oyladýnýz',
...
EOT;
    ...
    $lang_register_php = array('page_title' => 'Kullanýcý kaydý',
...
// File reviewcom.php
// ------------------------------------------------------------------------- //
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array('title' => 'Eleþtiri yorumlarý',
...
// if (defined('SEARCH_PHP'))
    $lang_search_php = array(0 => 'Resim arþivinde ara',
        );
// ------------------------------------------------------------------------- //
// File searchnew.php
// ------------------------------------------------------------------------- //
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Yeni resimler ara',
        ...
        'target_album' => '<strong>Resimlerini &quot;</strong>%s<strong>&quot; e g&ouml;nder </strong>%s',
        'folder' => 'Klas&ouml;r',
        'image' => 'Resim',
        'album' => 'Alb&uuml;m',
        'result' => 'Sonuç',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : Resminiz baþarý ile eklenmiþtir.' . '<li><strong>DP</strong> : Resim bir kopya, baþka bir kopyasý veritabanýnda bulunmaktadýr' . '<li><strong>PB</strong> : Resim y&uuml;klenemedi, resimlerin bulunduðu dizinlerin doðru ayarlanmýþ olduðundan emin olun' . '<li>Eðer OK, DP, PB \'signs\' iþaretlerinden biri çýkmýyorsa, kýrýk resmin &uuml;zerine týklayýn PHP hata iletisini g&ouml;rebilmek için' . '<li>Eðer sunucu zaman baðlantý hatasý olursa, yenile tuþuna basýn' . '</ul>',
...
// File upload.php
// ------------------------------------------------------------------------- //
if (defined('UPLOAD_PHP')) $lang_upload_php = array('title' => 'Resim y&uuml;kleme',
...
// File usermgr.php
// ------------------------------------------------------------------------- //
if (defined('USERMGR_PHP')) $lang_usermgr_php = array('title' => 'Kullanýcýlar d&uuml;zenle',
...
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Resimleri boyutlandýr',
