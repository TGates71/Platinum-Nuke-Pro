...
$lang_errors = array('access_denied' => 'Teil pole õigusi sellele lehele pääsuks',
...
$lang_thumb_view = array('date' => 'KUUPÄEV', 
...
// ------------------------------------------------------------------------- //
if (defined('SMILIES_PHP')) $lang_smilies_inc_php = array('Exclamation' => 'Hüüatus',
        'Question' => 'Küsimus',
...
array(
'Peatabeli laius (pixelites või %)', 'main_table_width', 0),
array(
...
array(
'Näita esimese taseme albumite pisipilte kategooriates', 'first_level', 1), 
        // 'Thumbnail view',
        'Pisipiltide vaade',
array(
...
array(
'Vaikejärjestus piltidele', 'default_sort_order', 3),
array(
'Minimaalne häälte arv pildi sattumiseks \'Edetabel\' nimekirja', 'min_votes_for_rating', 0),
array(
...
array(
'Tabeli laius pildi kuvamiseks (pixelites või %)', 'picture_table_width', 0),
array(
'Pildi info on vaikimisi nähtav', 'display_pic_info', 1),
array(
'Filtreeri pahad sõnad kommentaarides', 'filter_bad_words', 1),
array(
...
array(
'Pisipildi max laius või kõrgus <strong>*</strong>', 'thumb_width', 0),
array(
'Kasuta mõõte (kõrgus või laius või Max aspect pisipiltide jaoks )<strong>*</strong>', 'thumb_use', 7),
array(
'Loo keskmised pildid', 'make_intermediate', 1),
array(
'Keskmiste piltide laius või kõrgus <strong>*</strong>', 'picture_width', 0),
array(
'Salvestatud piltide max suurus (KB)', 'max_upl_size', 0),
array(
'Salvestatud piltide max laius või kõrgus (pixelites)', 'max_upl_width_height', 0), 
        // 'User settings',
        'Kasutaja seaded',
array(
'Luba uue kasutaja registreerimist', 'allow_user_registration', 1),
array(
'Kasutaja registreerimine nõuab eposti-kinnitust', 'reg_requires_valid_email', 1),
array(
'Luba kahel kasutajal ühte-sama eposti aadressi', 'allow_duplicate_emails_addr', 1),
array(
'Kasutajatel võib olla privaat-albumid', 'allow_private_albums', 1), 
        array('Show Users avatar instead of private album picture', 'avatar_private_album', 1),
//'Custom fields for image description (leave blank if unused)',
        'Kohandatavad väljad pildi kirjelduseks (jäta tühjaks kui ei kasuta)',
array(
'Välja 1 nimi', 'user_field1_name', 0),
array(
'Välja 2 nimi', 'user_field2_name', 0),
array(
'Välja 3 nimi', 'user_field3_name', 0),
array(
'Välja 4 nimi', 'user_field4_name', 0), 
        // 'Pictures and thumbnails advanced settings',
        'Piltide ja pisipiltide lisaseaded',
array(
'Faili nimes keelatud tähemärgid', 'forbiden_fname_char', 0),
array(
'Lubatud failitüübid salvestatavatele piltidele', 'allowed_file_extensions', 0),
array(
'Piltide suurusemuutmise meetod', 'thumb_method', 2),
array(
'ImageMagick / netpbm \'u \'konvertimise\' abiprogrammi tee (näiteks /usr/bin/X11/)', 'impath', 0),
array(
'Lubatud pilditüübid (ainult ImageMagick / netpbm \'u jaoks)', 'allowed_img_types', 0),
array(
'Käsurea parameetrid ImageMagick / netpbm \'ule', 'im_options', 0),
array(
...
array(
'Skripti poolt kasutatava prääniku nimi', 'cookie_name', 0),
array(
'Skripti poolt kasutatava prääniku failitee', 'cookie_path', 0),
array(
'Tähtekodeering', 'charset', 4), 
        // 'Miscellaneous settings',
        'Muud seaded',
array(
'Võimalda parandusmood', 'debug_mode', 1),
array(
...
// File db_input.php
// ------------------------------------------------------------------------- //
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array('empty_name_or_com' => 'Sa pead trükkima oma nime ja kommentaari',
...
if (defined('DISPLAYIMAGE_PHP')) {
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Akna sulgemiseks klõpsa pildil',
...
// File reviewcom.php
// ------------------------------------------------------------------------- //
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array('title' => 'Kommentaaride ülevaade',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Otsi uusi pilte',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : tähendab, et pilt lisati edukalt' . '<li><strong>DP</strong> : tähendab, et pilt on dublikaat ja sisaldub juba andmebaasis' . '<li><strong>PB</strong> : tähendab, et pilti ei saa lisada, kontrolli oma seadeid ja kataloogi õigusi kus su pildid asuvad' . '<li>Kui märgid \'OK, DP, PB\' ei ilmu, klikka katkenud pildil nägemaks mistahes PHP poolt antud veateadet' . '<li>Kui su sirvijal on \'timeout\', vajuta reload nuppu' . '</ul>',
