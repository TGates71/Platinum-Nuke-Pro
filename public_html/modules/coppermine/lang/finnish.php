...
$lang_errors = array('access_denied' => 'Ei oikeuksia tälle sivulle.',
...
$lang_rate_pic = array('rate_this_pic' => 'Äänestä tätä kuvaa ',
...
// File admin.php
// ------------------------------------------------------------------------- //
if (defined('ADMIN_PHP')) $lang_admin_php = array(0 => 'Poistuu ylläpitotilasta...',
...
if (defined('CONFIG_PHP'))
    $lang_config_data = array(
        ...
        array(
            'Gallerian ylläpitäjän sähköposti', 'gallery_admin_email', 0),
        array(
...
// for postnuke change
        ...
        array(
            'Päätaulukon leveys (pikseleissä tai %)', 'main_table_width', 0),
        array(
            'Kuinka monta kategoriaa näytetään tasolla', 'subcat_level', 0),
        array(
            'Kuinka monta albumia näytetään sivulla', 'albums_per_page', 0),
        array(
            'Kuinka monta saraketta näytetään albumi listassa', 'album_list_cols', 0),
        array(
            'Thumbnailien koko pikseleissä', 'alb_list_thumb_size', 0),
        array(
            'Mitä tietoja etusivulla näytetään', 'main_page_layout', 0),
        array(
            'Näytä ensimmäisen tason albumin thumbnailit kategoriassa', 'first_level', 1), 
        // 'Thumbnail view',
        'Thumbnailien näyttö',
        array(
            'Sarakkeita thumbnail sivulla', 'thumbcols', 0),
        array(
            'Rivejä thumbnail sivulla', 'thumbrows', 0),
        array(
            'Kaistaleiden maksimi määrä', 'max_tabs', 0),
        array(
            'Näytä kuvateksti thumbnaileissa', 'caption_in_thumbview', 1),
        array(
            'Näytä kommenttien määrä thumbnaileissa', 'display_comment_count', 1),
        array(
            'Kuvien oletus järjestys', 'default_sort_order', 3),
        array(
            'Tarvittavien äänien määrä ennen \'suosituimmat\' listalle pääsyä', 'min_votes_for_rating', 0),
        array(
        ...
        array(
            'Kuvan näyttö taulukon leveys (pikseleinä tai %)', 'picture_table_width', 0),
        array(
            'Kuvan info oletuksena piilotettu', 'display_pic_info', 1),
        array(
            'Rumasana filtteri', 'filter_bad_words', 1),
        array(
            'Hyväksy hymiöt kommentissa', 'enable_smilies', 1),
        array(
        ...
        array(
            'Maksimi määrä merkkejä sanassa', 'max_com_wlength', 0),
        array(
            'Kommentti rivien maksimi määrä', 'max_com_lines', 0),
        array(
            'Kommentin maksimi pituus', 'max_com_size', 0),
        array(
            'Näytä thumbnaileja kuva sivulla', 'display_film_strip', 1),
        array(
...
//'Pictures and thumbnails settings',
        ...
        array(
            'Käytä mittaa ( leveys tai korkeus tai Maksimi mitta thumbnaileissa )<strong>*</strong>', 'thumb_use', 7),
        array(
            'Luo väliaikaiset kuvat', 'make_intermediate', 1),
        array(
            'Väliaikaiset kuvien maksimi leveys tai korkeus <strong>*</strong>', 'picture_width', 0),
        array(
            'Ladattavien kuvien maksimi koko (KB)', 'max_upl_size', 0),
        array(
            'Ladattavien kuvien maksimi leveys (pikseleinä)', 'max_upl_width_height', 0), 
        // 'User settings',
        'Käyttäjä asetukset',
        array(
            'Salli uusien käyttäjien rekisteröityä', 'allow_user_registration', 1),
        array(
            'Rekisteröinti vaatii sähköposti varmistuksen', 'reg_requires_valid_email', 1),
        array(
            'Salli kahdelle käyttäjälle sama sähköposti osoite', 'allow_duplicate_emails_addr', 1),
        array(
            'Käyttäjät saavat yksityiset albumit', 'allow_private_albums', 1), 
        array('Show Users avatar instead of private album picture', 'avatar_private_album', 1),
//'Custom fields for image description (leave blank if unused)',
        'Valinnaiset kentät kuvan näytössä (jätä tyhjäksi jos et halua käyttää)',
        array(
            'Kenttä 1 nimi', 'user_field1_name', 0),
        array(
            'Kenttä 2 nimi', 'user_field2_name', 0),
        array(
            'Kenttä 3 nimi', 'user_field3_name', 0),
        array(
            'Kenttä 4 nimi', 'user_field4_name', 0), 
        // 'Pictures and thumbnails advanced settings',
        'Kuvien ja thumbnailien lisä asetukset',
        array(
            'Näytä yksityisessa albumissa Ikoni kirjautumattomalle käyttäjälle', 'show_private', 1),
        array(
            'Kielletyt merkit tiedostonimissä', 'forbiden_fname_char', 0),
        array(
            'Hyväksytyt tiedotopäätteet', 'allowed_file_extensions', 0),
        array(
            'Kuvien koot muutetaan käyttämällä', 'thumb_method', 2),
        array(
            'Täydellinen ImageMagick polku \'konventteri\' (esimerkiksi /usr/bin/X11/)', 'impath', 0),
        array(
            'Kyväksytyt kuva tyypit (kelpaa vain ImageMagickia käytettäessä)', 'allowed_img_types', 0),
        array(
        ...
        array(
            'Käyttäjien kuvien hakemisto <strong>*</strong>', 'userpics', 0),
        array(
            'Väliaikaisten kuvien etuliite <strong>*</strong>', 'normal_pfx', 0),
        array(
        ...
        array(
            'Evästeen nimi', 'cookie_name', 0),
        array(
            'Evästeen polku', 'cookie_path', 0),
        array(
            'Käytettävä koodaus', 'charset', 4), 
        // 'Miscellaneous settings',
        'Muut asetukset',
        array(
            'Näytä palvelimen virheilmoitukset', 'debug_mode', 1),
        array(
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Haluatko varmasti POISTAA tämän kuvan ? \\nKommentit poistetaan samalla.',
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Klikkaa kuvaa sulkeaksesi tämä ikkuna',
        );
} 
// ------------------------------------------------------------------------- //
// File ecard.php
// ------------------------------------------------------------------------- //
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'lähetä e-kortti',
        'invalid_email' => '<strong>Varoitus</strong> : virheellinen sähköposti osoite!',
...
// File groupmgr.php
// ------------------------------------------------------------------------- //
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Ryhmän nimi',
        'disk_quota' => 'Levytila',
        ...
        'note1' => '<strong>(1)</strong> Lisäykset julkiseen albumiin tarvitsevat ylläpidon hyväksynnän',
        'note2' => '<strong>(2)</strong> Lisäykset käyttäjän albumiin tarvitsevat ylläpidon hyväksynnän',
        'notes' => 'Huomio'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_album_admin_menu = array('confirm_delete' => 'Haluatko varmasti POISTAA tämän albumin ? \\nKaikki kuvat ja kommentit poistetaan myös.',
        'delete' => 'POISTA',
        'modify' => 'MUOKKAA',
        'edit_pics' => 'MUOKKAA KUVIA',
        );
    ...
    $lang_list_categories = array('home' => 'Etusivu',
        'stat1' => '<strong>[pictures]</strong> kuvaa <strong>[albums]</strong> albumia ja <strong>[cat]</strong> kategoriaa sekä <strong>[comments]</strong> kommentia. Kuvia tarkasteltu <strong>[views]</strong> kertaa',
    ...
    $lang_list_users = array('user_list' => 'Käyttäjä lista',
...
// File modifyalb.php
// ------------------------------------------------------------------------- //
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array('upd_alb_n' => 'Päivitä albumi %s',
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Olet jo arvostellut tämän kuvan',
...
EOT;
    ...
    $lang_register_php = array('page_title' => 'Rekisteröinti',
...
// File reviewcom.php
// ------------------------------------------------------------------------- //
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array('title' => 'Näytä kommentit',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Etsi uusia kuvia',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : tarkoittaa kuva lisätty onnistuneesti' . '<li><strong>DP</strong> : tarkoittaa kuva on jo aiemmin lisätty' . '<li><strong>PB</strong> : tarkoittaa kuvaa ei voitu lisätä, tarkista asetukset ja oikeudet' . '<li>Jos OK, DP, PB \'merkit\' eivät ilmesty klikkaa rikkinäistä kuvaa nähdäksesi PHP: virheilmoituksen' . '<li>Jos selaimesi menee timeouttiin, lataa sivu uudestaan' . '</ul>',
...
// File upload.php
// ------------------------------------------------------------------------- //
if (defined('UPLOAD_PHP')) $lang_upload_php = array('title' => 'Lisää kuva',
...
// File usermgr.php
// ------------------------------------------------------------------------- //
if (defined('USERMGR_PHP')) $lang_usermgr_php = array('title' => 'Muokkaa käyttäjiä',
        ...
        'password' => 'Salasana',
        'user_active_cp' => 'Käyttäjä aktiivinen',
        'user_group_cp' => 'Käyttäjän ryhmä',
        'user_email' => 'Käyttäjän sähköposti',
        'user_web_site' => 'Käyttäjän kotisivu',
        'create_new_user' => 'Luo uusi käyttäjä',
        'user_from' => 'Käyttäjän sijainti',
        'user_interests' => 'Käyttäjän kiinnostukset',
        'user_occ' => 'Käyttäjän koulutus',
        );
// ------------------------------------------------------------------------- //
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Pienennä kuvia',
