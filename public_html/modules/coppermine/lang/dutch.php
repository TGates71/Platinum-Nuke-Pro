...
if (defined('CONFIG_PHP'))
    $lang_config_data = array(
       ...
       array('galerij naam', 'gallery_name', 0),
        ...
        array('Adres naar nuke map vb http://www.mijnsite.tld/', 'ecards_more_pic_target', 0),
        array('Taal', 'lang', 5),
// for postnuke change
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array('Activeer geadvanceerde debug-modus', 'advanced_debug_mode', 1), // new in cpg1.2.0nuke
...
if (defined('DISPLAYIMAGE_PHP')) {
    ...
    $lang_picinfo = array('title' => 'Foto informatie',
        ...
        'iptcSubCategories' => 'IPTC Sub Categorieën', // new in cpg1.2.0nuke
