...
$lang_gallery_admin_menu = array('upl_app_lnk' => 'Aprobar Uploads',
    'config_lnk' => 'ConfiguraciÃ³n',
    'albums_lnk' => 'Albums',
    'categories_lnk' => 'CategorÃ­as',
    'users_lnk' => 'Usuarios',
    'groups_lnk' => 'Grupos',
    'comments_lnk' => 'Comentarios',
    'searchnew_lnk' => 'AÃ±adir fotos (Batch)',
...
$lang_cat_list = array('category' => 'CategorÃ­a',
    'albums' => 'Albums',
    'pictures' => 'Fotos',
    );
...
if (defined('CONFIG_PHP')) $lang_config_data =
    array(
        ...
        array(
            'Nombre de la galerÃ­a', 'gallery_name', 0),
        array(
            'DescripciÃ³n de la galerÃ­a', 'gallery_description', 0),
        array(
            'Correo electrÃ³nico del administrador', 'gallery_admin_email', 0),
        array(
...
// for postnuke change
        ...
        array(
            'NÃºmero de niveles de categorÃ­as a mostrar', 'subcat_level', 0),
        array(
            'NÃºmero de albums a mostrar', 'albums_per_page', 0),
        array(
            'NÃºmero de columnas en la lista de albums', 'album_list_cols', 0),
        array(
            'TamaÃ±o de los thumbnails en pixels', 'alb_list_thumb_size', 0),
        array(
            'Contenido de la pÃ¡gina principal', 'main_page_layout', 0),
        array(
            'Mostrar thumbnails de albums de primer nivel en categorÃ­as', 'first_level', 1), 
        // 'Thumbnail view',
        'Aspecto de la vista de Thumbnails',
        array(
            'NÃºmero de columnas en la pÃ¡gina de thumbnails', 'thumbcols', 0),
        array(
            'NÃºmero de filas en la pÃ¡gina de thumbnails', 'thumbrows', 0),
        array(
            'MÃ¡ximo nÃºmero de tabs a mostrar', 'max_tabs', 0),
        array(
            'Mostrar picture caption (ademÃ¡s del tÃ­tulo) debajo del thumbnail', 'caption_in_thumbview', 1),
        array(
            'Mostrar el nÃºmero de comentarios debajo del thumbnail', 'display_comment_count', 1),
        array(
            'Orden por defecto de las fotos', 'default_sort_order', 3),
        array(
            'Minimo nÃºmero de votos para que una foto aparezca el la lista de \'MÃ¡s Valoradas\' list', 'min_votes_for_rating', 0),
        array(
            'Alts and title tags of thumbnail show title and keyword instead of picinfo', 'seo_alts', 1), // new in cpg1.2.0nuke
        // 'Image view &amp; Comment settings',
        'Vista de foto y ConfiguraciÃ³n de comentarios',
        array(
            'Anchura de la tabla donde mostrar la foto (pixels o %)', 'picture_table_width', 0),
        array(
            'InformaciÃ³n de la foto visible por defecto', 'display_pic_info', 1),
        array(
        ...
        array(
            'MÃ¡xima longitud para la descripciÃ³n de una foto', 'max_img_desc_length', 0),
        array(
            'MÃ¡ximo nÃºmero de caracteres en una palabra', 'max_com_wlength', 0),
        array(
            'MÃ¡ximo nÃºmero de lineas en un comentario', 'max_com_lines', 0),
        array(
            'MÃ¡xima longitud de un comentario', 'max_com_size', 0),
        array(
            'Mostrar tira de pelÃ­cula', 'display_film_strip', 1),
        array(
            'NÃºmero de objetos en tira de pelÃ­cula', 'max_film_strip_items', 0),
        array(
            'Allow viewing of full size pic by anonymous', 'allow_anon_fullsize', 1), // new in cpg1.2.0nuke
        array('Number of days between being able to vote on the same image','keep_votes_time',0), // new in cpg1.2.2c nuke
//'Pictures and thumbnails settings',
        'ConfiguraciÃ³n de las fotos y thumbnails',
        array(
            'Calidad para los ficheros JPEG', 'jpeg_qual', 0),
        array(
            'MÃ¡xima anchura o altura de los thumbnail <strong>*</strong>', 'thumb_width', 0),
        array(
            'Usar dimensiÃ³n ( anchura o altura o MÃ¡ximo para los thumbnail )<strong>*</strong>', 'thumb_use', 7),
        array(
            'Crear fotos de tamaÃ±o intermedio', 'make_intermediate', 1),
        array(
            'MÃ¡xima anchura o altura de las fotos de tamaÃ±o intermedio <strong>*</strong>', 'picture_width', 0),
        array(
            'MÃ¡ximo tamaÃ±o de los fotos de usuarios por upload (KB)', 'max_upl_size', 0),
        array(
            'MÃ¡xima anchura o altura de las fotos de usuarios por upload (pixels)', 'max_upl_width_height', 0), 
        // 'User settings',
        'ConfiguraciÃ³n de usuarios',
        array(
            'Permitir el registro de nuevos usuarios', 'allow_user_registration', 1),
        array(
            'Registro de usuarios requiere verificaciÃ³n de email', 'reg_requires_valid_email', 1),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        'Campos extra para descripciÃ³n de fotos (dejar en blanco si no los usas)',
        array(
        ...
        'ConfiguraciÃ³n avanzada de fotos y thumbnails',
        array(
        ...
        array(
            'Prefijo para las fotos de tamaÃ±o intermedio <strong>*</strong>', 'normal_pfx', 0),
        array(
        ...
        'ConfiguraciÃ³n de cookies y Juego de Caracteres',
        array(
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array('empty_name_or_com' => 'Debes introducir tu nombre y un comentario',
        ...
        'err_fsize_too_large' => 'El tamaÃ±o de la foto que quieres insertar es demasiago grande (el mÃ¡ximo permitido es de %s x %s)',
        'err_imgsize_too_large' => 'El tamaÃ±o del fichero de la foto que quieres insertar es demasiado grande (el mÃ¡ximo permitido es de %s KB)',
...
if (defined('DELETE_PHP')) $lang_delete_php = array('caption' => 'Caption',
        ...
        'update_alb' => 'Actualizando album \'%s\' con el tÃ­tulo \'%s\' y el Ã­ndice \'%s\'',
        'del_pic' => 'Borrar foto',
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Â¿EstÃ¡s seguro de querer BORRAR esta foto? \\nLos comentarios serÃ¡n tambiÃ©n borrados.',
        ...
        'view_fs' => 'Pulsa aqui para ver la imagen a tamaÃ±o completo',
        'edit_pic' => 'EDIT PICTURE INFO', // new in cpg1.2.0nuke
        );

    $lang_picinfo = array('title' => 'InformaciÃ³n de la foto',
...
// File editpics.php
// ------------------------------------------------------------------------- //
if (defined('EDITPICS_PHP')) $lang_editpics_php = array('pic_info' => 'InformaciÃ³n',
        'album' => 'Album',
        'title' => 'TÃ­tulo',
        'desc' => 'DescripciÃ³n',
        'keywords' => 'Keywords',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Nombre del grupo',
        ...
        'can_upload' => 'Pueden aÃ±adir fotos',
        ...
        'note1' => '<strong>(1)</strong> AÃ±adir fotos en un album pÃºblico requerirÃ¡ aprobaciÃ³n de los administradores',
        'note2' => '<strong>(2)</strong> AÃ±adir fotos en un album que pertenece al asuario requerirÃ¡ aprobaciÃ³n de los administradores',
        'notes' => 'Notas'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_list_categories = array('home' => 'Home',
        'stat1' => '<strong>[pictures]</strong> fotos en <strong>[albums]</strong> albums y <strong>[cat]</strong> categorÃ­as con <strong>[comments]</strong> comentarios, vistas <strong>[views]</strong> veces',
    ...
    $lang_list_albums = array('n_pictures' => '%s fotos',
        'last_added' => ', Ãºltima aÃ±adida el %s'
        );
} 
// ------------------------------------------------------------------------- //
// File login.php
...
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array('upd_alb_n' => 'Modificar album %s',
        ...
        'last_uploaded' => 'Ultima foto aÃ±adida',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Buscar nuevas fotos',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : significa que la foto fue aÃ±adida sin problemas' . '<li><strong>DP</strong> : significa que la foto es un duplicado y ya existe en la base de datos' . '<li><strong>PB</strong> : significa que la foto no puede ser aÃ±adida, por favor comprueba la configaraciÃ³n y los permisos de los directorios donde estÃ¡n las fotos' . '<li>Si los iconos OK, DP, PB no aparecen, pulsa sobre el icono de imagen no cargada para ver el error producido por PHP' . '<li>Si el navegador produce un timeout, pulsa el icono de Actualizar' . '</ul>',
