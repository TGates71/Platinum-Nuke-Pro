...
echo "<tr><td bgcolor='$bgcolor2' valign='top'><strong>"._ML_LISTDESCRIPTION."</strong></td><td><textarea name='description' rows='10' cols='40'>".$list_info['description']."</textarea></td></tr>\n";
