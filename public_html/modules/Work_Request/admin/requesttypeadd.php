...
echo "<input type='hidden' name='op' value='WRRequestTypeInsert'>";
...
echo "<td><textarea name='type_description' cols='60' rows='10'></textarea></td></tr>";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._WR_TYPEADD."'></td></tr>";
echo "</form>";
echo "</table>";
CloseTable();
