...
wradmin_menu();
echo "<br />\n";
title(_WR_PROJECTEDIT);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>";
echo "<form method='post' action='".$admin_file.".php'>";
echo "<input type='hidden' name='op' value='WRProjectUpdate'>";
...
echo "<td><select name='featured'><option value='0'$sel1>"._WR_NO."</option>\n";
echo "<option value='1'$sel2>"._WR_YES."</option></select></td></tr>\n";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._WR_PROJECTUPDATE."'></td></tr>";
echo "</form>";
echo "</table>";
CloseTable();
