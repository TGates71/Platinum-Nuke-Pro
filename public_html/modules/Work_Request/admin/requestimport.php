...
wradmin_menu();
echo "<br />\n";
title(_WR_IMPORTASTASK);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='WRRequestImportInsert'>\n";
...
echo "</select></td></tr>\n";        
echo "<tr><td bgcolor='$bgcolor2'>"._WR_TASKNAME.":</td>\n";
...
echo "<tr><td bgcolor='$bgcolor2'>"._WR_PRIORITY.":</td>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'>"._WR_STATUSPERCENT.":</td>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'>"._WR_STARTDATE.":</td>\n";
...
echo "<tr><td bgcolor='$bgcolor2'>"._WR_FINISHDATE.":</td>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._WR_TASKADD."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
