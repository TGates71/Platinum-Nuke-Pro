...
$db->sql_query("UPDATE ".$prefix."_nsnwr_requests_comments SET commenter_name='$commenter_name', commenter_email='$commenter_email', comment_description='$comment_description' WHERE comment_id='$comment_id'");
