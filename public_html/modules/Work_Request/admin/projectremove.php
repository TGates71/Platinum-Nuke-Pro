...
wradmin_menu();
echo "<br />\n";
title(_WR_PROJECTDELETE);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>";
echo "<form method='post' action='".$admin_file.".php'>";
echo "<input type='hidden' name='op' value='WRProjectDelete'>";
echo "<input type='hidden' name='project_id' value='$project_id'>";
echo "<tr><td align='center'><strong>"._WR_PROJECTCONFIRMDELETE."</strong></td></tr>";
...
echo "<tr><td align='center'><input type='submit' value='"._WR_PROJECTDELETE."'></td></tr>";
echo "</form>";
echo "</table>";
CloseTable();
