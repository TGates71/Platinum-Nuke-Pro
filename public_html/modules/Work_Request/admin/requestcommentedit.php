...
$requestcomment = wrrequestcomment_info($comment_id);
$requestcomment['comment_description'] = wrunhtmlentities($requestcomment['comment_description']);
$requestcomment['comment_name'] = wrunhtmlentities($requestcomment['comment_name']);
wradmin_menu();
echo "<br />";
title(_WR_COMMENTEDIT);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>";
echo "<form method='post' action='".$admin_file.".php'>";
echo "<input type='hidden' name='op' value='WRRequestCommentUpdate'>";
...
echo "<tr><td bgcolor='$bgcolor2' valign='top'>"._WR_COMMENT.":</td>";
echo "<td><textarea name='comment_description' cols='60' rows='10'>".$requestcomment['comment_description']."</textarea></td></tr>";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._WR_COMMENTUPDATE."'></td></tr>";
echo "</form>";
echo "</table>";
CloseTable();
