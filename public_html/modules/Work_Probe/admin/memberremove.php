...
wpadmin_menu();
echo "<br />\n";
title(_WP_MEMBERDELETE);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='WPMemberDelete'>\n";
echo "<input type='hidden' name='member_id' value='$member_id'>\n";
echo "<tr><td align='center'><strong>"._WP_SWAPMEMBER."</strong></td></tr>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td align='center'><input type='submit' value='"._WP_MEMBERDELETE."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
