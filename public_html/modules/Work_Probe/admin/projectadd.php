...
wpadmin_menu();
echo "<br />\n";
title(_WP_PROJECTADD);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='WPProjectInsert'>\n";
...
echo "<td><select name='featured'><option value='0' selected>"._WP_NO."</option>\n";
echo "<option value='1'>"._WP_YES."</option></select></td></tr>\n";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._WP_PROJECTADD."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
