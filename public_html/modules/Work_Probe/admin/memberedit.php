...
wpadmin_menu();
echo "<br />\n";
title(_WP_MEMBEREDIT);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='WPMemberUpdate'>\n";
echo "<input type='hidden' name='member_id' value='$member_id'>\n";
echo "<tr><td bgcolor='$bgcolor2'>"._WP_MEMBERNAME.":</td>\n";
echo "<td><input type='text' name='member_name' size='30' value=\"$member_name\"></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'>"._WP_MEMBEREMAIL.":</td>\n";
echo "<td><input type='text' name='member_email' size='30' value=\"$member_email\"></td></tr>\n";
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._WP_MEMBERUPDATE."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
