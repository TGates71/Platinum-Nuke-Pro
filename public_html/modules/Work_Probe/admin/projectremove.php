...
wpadmin_menu();
echo "<br />\n";
title(_WP_PROJECTDELETE);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='WPProjectDelete'>\n";
echo "<input type='hidden' name='project_id' value='$project_id'>\n";
echo "<tr><td align='center'><strong>"._WP_PROJECTCONFIRMDELETE."</strong></td></tr>\n";
...
echo "<tr><td align='center'><input type='submit' value='"._WP_PROJECTDELETE."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
