...
$Theme_Sel = get_theme();
    echo "<html>\n";
    echo "<head>\n";
    echo "<title>"._WP_REPORTVIEW.": ".$report['report_name']."</title>\n";
    echo "</head>\n";
    echo "<body>\n";
require("themes/$Theme_Sel/theme.php");
echo "<center><h3>"._WP_REPORTVIEW.": ".$report['report_name']."</h3></center>\n";
echo "<br />\n";
...
echo "<tr><td colspan='4' width='100%'><nobr><strong>"._WP_PROJECTNAME."</strong></nobr></td></tr>\n";
...
echo "<tr><td colspan='2' width='100%'><nobr><strong>"._WP_REPORTINFO."</strong></nobr></td>\n";
echo "<td align='center'><strong>"._WP_STATUS."</strong></td>\n";
echo "<td align='center'><strong>"._WP_TYPE."</strong></td></tr>\n";
...
echo "<tr><td align='center'><img src='$wpimage'></td>\n";
echo "<td colspan='3' width='100%'><nobr>"._WP_REPORTER.": <strong>".$report['submitter_email']."</strong></nobr></td></tr>\n";
...
echo "<tr><td colspan='4' width='100%'><nobr><strong>"._WP_REPORTMEMBERS."</strong></nobr></td></tr>\n";
if($member_total != 0){
...
echo "<tr><td width='100%'><nobr><strong>"._WP_COMMENTS."</strong> <strong>(</strong> <a href='modules.php?name=$module_name&amp;op=WPReportCommentSubmit&amp;report_id=$report_id'>"._WP_COMMENTADD."</a> <strong>)</strong></nobr></td><tr>\n";
if($comment_total > 0){
