...
$db->sql_query("UPDATE ".$prefix."_nsnwp_reports_comments SET commenter_email='$commenter_email', commenter_name='$commenter_name', comment_description='$comment_description' WHERE comment_id='$comment_id'");
