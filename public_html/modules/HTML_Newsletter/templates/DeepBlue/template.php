	...
	<table border="0" align="center" width="138" cellpadding="0" cellspacing="0">
		<tr>
			<td class="titlebar" width="138" height="20">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FFFFFF"><strong>Site Statistics</strong></font>
			</td>
		</tr>
		<tr>
			<td>
...
<table border="0" align="center" width="95%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="title" width="100%" height="20">
			<font color="#FFFFFF"><strong>Our {AMOUNT} latest news items.</strong></font>
		</td>
...
<table border="0" align="center" width="95%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="title" width="100%" height="20">
			<font color="#FFFFFF"><strong>Our {AMOUNT} latest downloads.</strong></font>
		</td>
		<td width="25" height="20">
			<img alt="" src="{SITEURL}/modules/HTML_Newsletter/templates/{TEMPLATENAME}/table-title_03.gif" width="25" height="20" />
		</td>
...
<table border="0" align="center" width="95%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="title" width="100%" height="20">
			<font color="#FFFFFF"><strong>Our {AMOUNT} latest web links.</strong></font>
		</td>
		<td width="25" height="20">
			<img alt="" src="{SITEURL}/modules/HTML_Newsletter/templates/{TEMPLATENAME}/table-title_03.gif" width="25" height="20" />
		</td>
...
<table border="0" align="center" width="95%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="title" width="100%" height="20">
			<font color="#FFFFFF"><strong>Our {AMOUNT} latest forum posts.</strong></font>
		</td>
		<td width="25" height="20">
			<img alt="" src="{SITEURL}/modules/HTML_Newsletter/templates/{TEMPLATENAME}/table-title_03.gif" width="25" height="20" />
		</td>
