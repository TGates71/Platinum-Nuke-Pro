...
define('_MSNL_ADM_HLP_TEXTBODY',					'This is where the main text of your newsletter '
	...
	.'For long newsletter text, you may wish to use anchor tags to <strong>mark</strong> '
	.'certain sections.  Give them descriptive names and then check the <strong>Include Table of '
	.'Contents</strong> checkbox below and these anchors will become links within the Table of '
	.'Contents within your newsletter! <br /><br />For example, one could use: '
	.'<strong>& lt;a name=\'Section One\'& gt;& lt;/a& gt;</strong>. <strong>NOTE:</strong> Must be EXACTLY as shown '
	.'with double quotes AND the closing anchor tag! This example would produce a link called '
	.'<strong>Section One</strong> within the Table of Contents and upon clicking it, would take '
...
define('_MSNL_ADM_HLP_TEMPLATES',					'The list below is derived from the current '
	...
	.'If you elect to go with <strong>no template</strong>, the system will simply send to your recipients '
	.'an email with the text you entered above in the <strong>Newsletter Text</strong> text area.<br /><br />'
	.'To create a newsletter from a template, select one from the list.  To see a sample of what '
	.'your selected newsletter will look like, click on the <strong>View</strong> icon to the right of '
	.'the template name text.<br /><br />You can also create your own templates and place them '
	.'in the templates directory.  <strong>Hint:</strong> pattern off of Fancy_Content as this is the '
...
define('_MSNL_ADM_HLP_INCLTOC',						'Checking this option will include a Table of '
	...
	.'for Fancy_Content.  The TOC block will have links to each of the blocks of <strong>Latest xxxxxx</strong> '
	.'as well as links to any <strong>anchors</strong> included within the <strong>Newsletter Text</strong> text area.'
	);
...
define('_MSNL_ADM_HLP_WHOSNDTOADM',				'Choosing this option will send a test newsletter '
	...
	.'be sent to your intended recipients, use the <strong>Send Tested</strong> link towards the '
	.'top of this page.'
	);
...
define('_MSNL_CFG_HLP_DEBUGMODE',					'This allows the module admin to set various levels of '
	...
	.'web site as it could provide alot of useful information to a hacker!). <strong>NOTE: emails '
	.'will NOT be sent using this option</strong> - very useful for debugging purposes.'
	);
...
define('_MSNL_CAT_HLP_CATBLOCKLMT',				'This field is used only if the <strong>show categories</strong> '
	.'configuration option is checked and must be greater than zero.  Enter here the number of '
	.'newsletters that should be shown under this category in the block. <strong>If a value is not '
...
define('_MSNL_NLS_CHG_HLP_NSNGRPS', 			'Requires that the above <strong>view</strong> option '
	...
	.'For more than one group, each group ID should be separated by a dash, e.g. <strong>1-2-3</strong>.'
	);
