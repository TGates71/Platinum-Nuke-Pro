...
echo "</head>";
echo "<body>";
echo "<font class=\"content\"><center><strong>"._NSDLHLPGENIMAGES."</strong></center><br><br>";
echo "<div align=\"justify\">";

echo "<strong>&#8226; "._NSDLHLPFEATIMG."</strong><br>";
echo ""._NSDLHLPFEATIMG2."<br><br>";

echo "<strong>&#8226; "._NSDLHLPCATIMG."</strong><br>";
echo ""._NSDLHLPCATIMG2."<br><br>";

echo "<strong>&#8226; "._NSDLHLPSUBCATIMG."</strong><br>";
echo ""._NSDLHLPSUBCATIMG2."<br><br>";

echo "<strong>&#8226; "._NSDLHLPLINKIMG."</strong><br>";
echo ""._NSDLHLPLINKIMG2."<br><br>";


echo ""._NSDLHLPGENIMAGES2."";
