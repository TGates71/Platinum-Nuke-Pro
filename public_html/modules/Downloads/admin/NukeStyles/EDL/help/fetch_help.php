...
echo "</head>";
echo "<body>";
echo "<font class=\"content\"><center><strong>"._NSDLFETCHSETTINGS."</strong></center><br><br>";
echo "<div align=\"justify\">";

echo "<strong>&#8226;</strong> "._NSDLFETCHHELP1."<br><br>";
echo "<strong>&#8226;</strong> "._NSDLFETCHHELP2."<br><br>";
echo "<strong>&#8226;</strong> "._NSDLFETCHHELP3."<br><br>";
echo "<strong>&#8226;</strong> "._NSDLFETCHHELP4."<br><br><br>";
