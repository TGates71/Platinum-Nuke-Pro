...
$pagetitle = ": "._SP_MAINTITLE." "._SP_ADMINMAIN." ".$sp_config['version_number']." - "._SP_ACTIVESITES;
include_once("header.php");
title(_SP_MAINTITLE." "._SP_ADMINMAIN." ".$sp_config['version_number']." - "._SP_ACTIVESITES);
spmenu();
echo "<br />\n";
OpenTable();
$a = 0;
...
if($numrows > 0) {
  ...
  while($site_row = $db->sql_fetchrow($result)) {
    ...
    echo " <a href='".$admin_file.".php?op=SPDeactivate&amp;site_id=".$site_row['site_id']."'><img src='modules/Supporters/images/deactivate.png' border='0' alt='"._SP_DEACTIVATE."' title='"._SP_DEACTIVATE."'></a>";
