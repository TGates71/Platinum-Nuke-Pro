...
if($newimage_name != "") {
  ...
  if(move_uploaded_file($newimage_temp, "modules/Supporters_2/images/supporters/$oid$ext")) {
...
$result = $db->sql_query("UPDATE `".$prefix."_nsnsp_2_sites` SET `site_name`='$site_name', `site_url`='$site_url', `site_image`='$imgurl', `site_date`='$site_date', `site_description`='$site_description', `user_name`='$user_name', `user_email`='$user_email' where `site_id`='$site_id'");
