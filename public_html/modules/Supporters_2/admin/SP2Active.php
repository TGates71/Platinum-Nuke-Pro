...
$pagetitle = ": "._SP2_MAINTITLE." "._SP2_ADMINMAIN." ".$sp_config['version_number']." - "._SP2_ACTIVESITES;
include_once("header.php");
title(_SP2_MAINTITLE." "._SP2_ADMINMAIN." ".$sp_config['version_number']." - "._SP2_ACTIVESITES);
sp2menu();
echo "<br />\n";
OpenTable();
$a = 0;
...
if($numrows > 0) {
  ...
  while($site_row = $db->sql_fetchrow($result)) {
    ...
    echo " <a href='".$admin_file.".php?op=SP2Deactivate&amp;site_id=".$site_row['site_id']."'><img src='modules/Supporters_2/images/deactivate.png' border='0' alt='"._SP2_DEACTIVATE."' title='"._SP2_DEACTIVATE."'></a>";
  ...
  echo "<center class='title'>"._SP2_NOACTIVESITES."</center>\n";
}
CloseTable();
