...
$pagetitle = ": "._SP2_MAINTITLE." "._SP2_ADMINMAIN." ".$sp_config['version_number']." - "._SP2_SUBMITTEDSITES;
include_once("header.php");
title(_SP2_MAINTITLE." "._SP2_ADMINMAIN." ".$sp_config['version_number']." - "._SP2_SUBMITTEDSITES);
sp2menu();
echo "<br />\n";
OpenTable();
$a = 0;
$result = $db->sql_query("SELECT * FROM `".$prefix."_nsnsp_2_sites` WHERE `site_status`='0' ORDER BY `site_name`");
...
if($numrows > 0) {
  ...
  while($site_row = $db->sql_fetchrow($result)) {
    ...
    echo " <a href='".$admin_file.".php?op=SP2Approve&amp;site_id=".$site_row['site_id']."'><img src='modules/Supporters_2/images/approve.png' border='0' alt='"._SP2_APPROVE."' title='"._SP2_APPROVE."'></a>";
  ...
  echo "<center class='title'>"._SP2_NOSUBMITTEDSITES."</center>\n";
}
CloseTable();
