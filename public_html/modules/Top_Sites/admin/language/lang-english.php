...
define("_NUMSITE","Site ID");
define("_MODIFY","Modify");
define("_DEL","DELETE");

define("_LINKALREADYEXT","ERROR: This URL is already listed in the Database or is waiting for validation!");
...
define("_NOMATCHES","No matches found for your query");
...
define("_PROMOTE01","Maybe you will be interested in several of the remote 'Rate a Website' options we have available. These allow you to place an image (or even a rating form) on your web site in order to increase the number of votes received for your resource. Please choose from one of the options listed below:");
...
define("_IDREFER","in the HTML source references your site's ID number in the $sitename database. Be sure this number is present.");
...
define("_COMPLETEVOTE4","You cannot vote on a link you submitted yourself.<br>All votes are logged and reviewed.");
...
define("_YOUCANVOTE","You can vote again in");
define("_DAYS","day(s)");
...
//admin
define("_URL","URL");
define("_LINKNOTVALIDATE","unvalidated links");
define("_LINKVALIDATE","validated links");
define("_CLEANVOTES","clear link votes");
...
define("_PARAMETERCONFIG","Configuration");
define("_CATEGORYEXIST","Existing catgories");
define("_NAME","Name");
define("_ADD","Add");
define("_ERRORTHECATEGORY","Error, the category ");
define("_ALREADYEXIST","already exists");
define("_THECATEGORY","The category ");
define("_ADDED2"," was added");
define("_MODIFIED"," ws modified");
define("_DELETED"," was deleted");
define("_NOLINKTOVALIDATE","No link to validate!");
define("_SAVECHANGES","Save");

define("_PERPAGE","Number of links per page");
define("_PERPAGE2","How many links to show on each page?");
define("_LINKSRESULT","Number of results");
define("_LINKSRESULT2","How many links to display on each search result page?");
define("_ANONWAITDAYS","Number of days before vote again");
define("_ANONWAITDAYS2","Number of days anonymous users need to wait to vote on a link");
define("_OUTSIDEWAITDAYS","Number of days before repetative vote");
define("_OUTSIDEWAITDAYS2","Number of days outside users need to wait to vote on a link again (checks IP)");
...
define("_ANONWEIGHT2","	How many unregistered user votes per 1 registered user vote ?");
define("_OUTSIDEWEIGHT","Ratio outside user:registered");
define("_OUTSIDEWEIGHT2","How many outside user votes per 1 registered user vote?");
define("_CATEGORYOPTION","Categories System?");
define("_CATEGORYOPTION2","Top Sites with categories system 1=Yes  0=No");
define("_MAXAFFICHAGE","Max. banners to display");
define("_MAXAFFICHAGE2","Number of maximum banners displayed on topsite ");
define("_RECEIVEMAIL","Admin receive email?");
define("_RECEIVEMAIL2","Want to receive an email when a user posts a link? 1=Yes  0=No");
define("_NUMLATEST","Number of links");
define("_NUMLATEST2","How many links to show on 'latest links'?");
define("_MAXIMAGEWIDTHSIZE","Max. width (for image resize)");
define("_MAXIMAGEWIDTHSIZE2","Maximum width of banners, 468 by default");
define("_MAXIMAGEHEIGHTSIZE","Max. Height (for image resize)");
define("_MAXIMAGEHEIGHTSIZE2","Maximum height of banners, 60 by default");
define("_ALTERNATAVECOLOR1","Color 1");
define("_ALTERNATAVECOLOR1_2","Alternative color 1 in 'latest links'");
define("_ALTERNATAVECOLOR2","Color 2");
define("_ALTERNATAVECOLOR2_2","Alternative color 2 in 'latest links'");
define("_NOCATEGORYNAME","Error, the field 'category' is empty !");
define("_CLEANALLSITES","Delete all sites");
define("_GLOBALBILAN","Global stat");
define("_RESIZEIMAGE","Image resize");
define("_RESIZEIMAGE2","Image resize for consistent site design? 1=Yes  0=No");

// version 1.3
define("_HELPANDRULES","Rules and Assistances");
define("_RULES0","Our Top Sites list doesn't accept racist or pornographic sites.<br>
                  Following the law, users could modify or delete their account.<br>
				  Admins could modify or delete any account if it doesn't comply with the rules of our site.<br> 
                  By submitting a link here, you accept to receive newsletter concerning our Top sites or your stats
				  (will be an option in next version of our Top Sites).<br>");
define("_RULES1","Option to erase after X days activated");
define("_RULES2","Votes are automatically cleared every");
define("_RULES3","The next reset is planned for");
define("_RULES4","Option 'Image resize' activated (slows down the script operation)");
define("_RULES5","Option 'Auto approval' activated");
define("_RULES6","A registered user can directly register his site without the validation by an admin");
...
define("_YOURLINKTOWEBLINK1","Your site is already registered in the Web_Link directory");
define("_YOURLINKTOWEBLINK2","Your site is also registered in the Web_Link directory");
...
define("_REMOVEHITS","Confirm the suppression of Hits (OUT) ?");
...
//version 1.4
define("_GIVEANOTE","Select a score between 1 and 10");
define("_CHOOSEANOTE","Choose a score by passing the mouse over the gauge");
define("_CLICKONOK","Click on OK to validate");
define("_NOYETSITE","Any site in Top Sites");
define("_NOYETSITEINTHISCAT","Any site in this category");
define("_RATINGNONULL","The score must not be null!");
define("_LATEST3","The 10 latest unvalidated links");
define("_NOTEBYJAVA","Notification by cursor and smilies");
