...
{
	$game_name = $_POST['add_gamename'];
	$game_desc = $_POST['add_gamedesc'];
	$game_swf = $_POST['add_gamefile'];
	$game_pic = $_POST['add_gamepicture'];
	$catid = $_POST['add_cat'];
	$game_width = $_POST['add_gamewidth'];
	$game_height = $_POST['add_gameheight'];
	$game_type = $_POST['add_gametype'];
	$game_scorevar = $_POST['add_scorevar'];
