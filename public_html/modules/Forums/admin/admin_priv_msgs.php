...
*
*   $Id: admin_priv_msgs.php,v 1.20 2003/08/18 22:38:47 nivisec Exp $
*
*
***************************************************************************/
...
if (!function_exists('find_lang_file_nivisec'))
{
	...
	* @desc Tries to locate and include_once the specified language file.  Do not include_once the .php extension!
	*/
...
switch($pmaction)
{
	...
	default:
	{
		...
		'URL_ip' => append_sid(basename(__FILE__) . "?pmaction=remove_ip&mode=$mode"),
		...
		************************************************************************/
		...
		{
			include_once($phpbb_root_path.'nivisec_version_check.'.$phpEx);
		}
		/************************************************************************
