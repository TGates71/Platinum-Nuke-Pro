...
/*               $sql = "SELECT config_value
                ...
                if ($initialusergroup == $group_id)
                $yesno = 1;
                else
                $yesno = 0;
*/				
/*****[BEGIN]**************Initial Usergroup ********************************/

                $initialusergroup = $board_config['initial_group_id'];
                ...
                if (intval($initialusergroup) == $group_id) {
                   $yesno = 1;
                } else {
                   $yesno = 0;
                }
/*****[END]****************Initial Usergroup  ****************************/					
                $mode = 'editgroup';
