 ...
 * of include_once'ing the lang_faq.php file and turns it into
...
if( !empty($setmodules) )
{
	...
	$module[$lang['Edit']][$lang['FAQ']] = "$file?file=faq";
	$module[$lang['Edit']][$lang['BBCode_guide']] = "$file?file=bbcode";
/*****************************************************/
/* Forum - Board Rules v.2.0.0                 START */
/*****************************************************/
	$module[$lang['Edit']]['Site Rules'] = "$file?file=rules";
/*****************************************************/
/* Forum - Board Rules v.2.0.0                   END */
/*****************************************************/
	return;
}
...
include_once("../../../includes/functions_selects.$phpEx");

// extra language variables for the actual editor 
include_once($phpbb_root_path . 'language/lang_' . $board_config['default_lang'] . '/lang_faq_editor.' . $phpEx);

// initially include_once the current FAQ or BBCode guide, depending on the file= in the query_string
$file = isset($_GET['file']) ? $_GET['file'] : 'faq';
...
include_once($phpbb_root_path . 'language/lang_' . $language . '/lang_' . $file . '.' . $phpEx);
...
<script>
function openpopup(){
var popurl="copyrightfaqeditor.php"
...
<?php
echo "<div align=\"right\" class=\"gen\"><a href=\"javascript:openpopup()\">FAQ Editor Mod &copy;</a></div>";
include_once('./page_footer_admin.'.$phpEx);
