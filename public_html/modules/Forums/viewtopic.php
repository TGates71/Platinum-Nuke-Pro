...
/*****************************************************/
$sql = "SELECT u.username, u.user_color_gc, u.user_id, u.user_items, u.user_privs, u.user_effects, u.user_custitle, u.user_posts, u.user_from, u.user_from_flag, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_regdate, u.user_msnm, u.user_viewemail, u.user_rank, u.user_rank2, u.user_rank3, u.user_rank4, u.user_rank5, u.user_sig, u.user_sig_bbcode_uid, u.user_avatar, u.user_avatar_type, u.user_allowavatar, u.user_allowsmile, u.user_birthday, u.user_next_birthday_greeting, u.user_allow_viewonline, u.user_session_time, u.user_gender, p.*,  pt.post_text, pt.post_subject, pt.bbcode_uid
...
/*****************************************************/
	...
	if ( $user_sig != '' )
	  ...
	  $message = preg_replace('#(?!<.*)(?<!\w)(' . $highlight_match . ')(?!\w|[^<>]*>)#i', '<b style="color:#'.$theme['fontcolor3'].'">\1</strong>', $message);
        }
...
/*****************************************************/
include_once("includes/postfields.php");
