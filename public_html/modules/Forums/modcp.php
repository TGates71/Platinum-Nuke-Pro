...
/*****************************quick title edition************************/
$attribute = isset($_POST['attribute']) ? TRUE : FALSE;
...
/*****************************************************
		...
		{
			$topics_sql = ( isset($_POST['topic_id_list']) ) ? implode(',', $_POST['topic_id_list']) : $topic_id;
...
/*****************************************************/
			...
			$db->sql_freeresult($result);
                        ...
                        $db->sql_freeresult($result);
                        //
                        // Got all require_onced info so go ahead and start deleting everything
                        //
/*****************************************************/
...
/*****************************************************/
                        ...
                        {
                                message_die(GENERAL_ERROR, 'Could not delete topic info for Thread Kicker Mod', '', __LINE__, __FILE__, $sql);
                        }
/*****************************************************/
...
/*****************************************************/
/* Forum - IP Whois Lookup v.1.0.0             START */
/*****************************************************/
                        'L_WHOIS_IP' => $lang['IP_Whois_Lookup'],
/*****************************************************/
/* Forum - IP Whois Lookup v.1.0.0               END */
/*****************************************************/
...
/* Forum - IP Whois Lookup v.1.0.0             START */
/*****************************************************/
                        'U_WHOIS_IP' => "http://ws.arin.net/cgi-bin/whois.pl?queryinput=". $ip_this_post . "",	
/*****************************************************/
/* Forum - IP Whois Lookup v.1.0.0               END */
/*****************************************************/
...
/*****************************************************/
                                        'L_WHOIS_IP' => $lang['IP_Whois_Lookup'],
                                        'U_WHOIS_IP' => "http://ws.arin.net/cgi-bin/whois.pl?queryinput=". $ip . "",
/*****************************************************/
/* Forum - IP Whois Lookup v.1.0.0               END */
/*****************************************************/
