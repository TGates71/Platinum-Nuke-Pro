 ...
 *
 *   $Id: functions_includes.php,v 1.38 2004/12/11 12:11:01 acydburn Exp $
 *
 *
 ***************************************************************************/
...
//
function attach_faq_include_once($lang_file)
{
	...
	if ($lang_file == 'lang_faq')
	{
		...
		{
			@include_once($phpbb_root_path . 'language/lang_english/lang_faq_attach.'.$phpEx);
		}
		else
		{
			@include_once($phpbb_root_path . 'language/lang_' . $board_config['default_lang'] . '/lang_faq_attach.' . $phpEx);
		}
	}
}
