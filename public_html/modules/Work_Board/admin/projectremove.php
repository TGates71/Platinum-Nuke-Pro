...
wbadmin_menu();
echo "<br />\n";
title(_WB_DELETEPROJECT);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='WBProjectDelete'>\n";
echo "<input type='hidden' name='project_id' value='$project_id'>\n";
echo "<tr><td align='center'><strong>"._WB_PROJECT_CONFIRMDELETE."</strong></td></tr>\n";
...
echo "<tr><td align='center'><input type='submit' value='"._WB_DELETEPROJECT."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
