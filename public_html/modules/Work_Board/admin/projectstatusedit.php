...
wbadmin_menu();
echo "<br />\n";
title(_WB_EDITPROJECTSTATUS);
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='WBProjectStatusUpdate'>\n";
...
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._WB_UPDATEPROJECTSTATUS."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
