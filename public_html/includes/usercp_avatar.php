...
/*****************************************************/
        ...
        if (count($nfield) > 0) {
        	foreach ($nfield as $key => $var) {
	        	$s_hidden_vars .= '<input type="hidden" name="nfield['.$key.']" value="' . str_replace('"', '&quot;', $var) . '" />';
        	}
    	}
/*****************************************************/
/*               Fields Mod                    END */
