...
// 
 ...
 if ( $debug || $board_config['ropm_quick_reply'] && $privmsg['privmsgs_from_userid'] != $userdata['user_id'] )
//if ( $board_config['ropm_quick_reply'])
{
$language = $board_config['default_lang'];
if ( !file_exists($phpbb_root_path . 'language/lang_' . $language . '/lang_main_pmqr.'.$phpEx) )
$language = 'english';
include_once($phpbb_root_path . 'language/lang_' . $language . '/lang_main_pmqr.' . $phpEx);
