...

{
	...
	global $db, $lang, $board_config, $session_id, $_COOKIE, $_GET, $SID;
...
// code you must include_once this routine, even if it's empty.
...

{
	...
	else if ((preg_match("/profile/", $url)) && (!preg_match("/highlight/", $url) && !preg_match("/profile/", $url)))
