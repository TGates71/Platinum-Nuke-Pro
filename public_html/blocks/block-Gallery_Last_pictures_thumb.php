...
while ($row = $db->sql_fetchrow($result)) {
    ...
    $content .= '<a href="' . $CPG_M_URL . '&amp;file=displayimage&amp;meta=lastup&amp;cat=0&amp;pos=' . $pic . '"><img src="' . get_pic_url($row, 'thumb') . '" border="0" alt="' . $thumb_title . '" title="' . $thumb_title . '"><br />' . truncate_stringblocks($thumb_title, $title_length) . '</a><br />';
    $pic++;
} 
