...
$supporterlt = $db->sql_fetchrow($db->sql_query("SELECT * from ".$prefix."_nsnsp_2_config"));
...
if ($supporterlt['require_user'] == 0 || is_user($user)) { $content .= "[ <a href='modules.php?name=Supporters_2&amp;op=SP2Submit'>"._SP2_BESUPPORTER."</a> ]<br />\n"; }
