...
while ($row = $db->sql_fetchrow($result)) {
    ...
    $content .= '<td align="center" valign="baseline"><a href="' . $CPG_M_URL . '&amp;file=displayimage&amp;meta=lastup&amp;cat=0&amp;pos=' . $pic . '"><img src="' . get_pic_url($row, 'thumb') . '" border="0" alt="' . $thumb_title . '" title="' . $thumb_title . '"><br />' . truncate_stringblocks($thumb_title) . '</a></td>';
    $pic++;
}
$content .= '</tr><tr align="center"><td colspan="' . $length . '" valign="baseline"><a href="' . $CPG_M_URL . '">' . $lang_pagetitle_php["photogallery"] . '</a><br /></center></td></tr></table>';
?>
