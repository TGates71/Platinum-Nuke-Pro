...
while ($row = $db->sql_fetchrow($result)) {
    ...
    $content .= '<p align="center"><a href="' . $CPG_M_URL . '&amp;file=displayimage&amp;meta=lastcom&amp;cat=0&amp;pos=' . $pic . '"><img src="' . get_pic_url($row, 'thumb') . '" border="0" alt="' . $thumb_title . '" title="' . $thumb_title . '"><br />' . truncate_stringblocks($author, $auth_length) . '</a> <br />' . truncate_stringblocks($messagebody, $body_length) . '<br />(' . $date . ')';
    $pic++;
} 
