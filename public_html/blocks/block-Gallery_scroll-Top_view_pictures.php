...
while ($row = $db->sql_fetchrow($result)) {
    ...
    $content .= '<a href="' . $CPG_M_URL . '&amp;file=displayimage&amp;meta=topn&amp;cat=0&amp;pid=' . $row["pid"] . '"><img src="' . get_pic_url($row, 'thumb') . '" border="0" alt="' . $thumb_title . '" title="' . $thumb_title . '"><br />' . $views_title . '</a><br /><br />';
    $pic++;
} 
