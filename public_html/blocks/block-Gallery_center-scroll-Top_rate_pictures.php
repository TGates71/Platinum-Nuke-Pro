...
/*******************************************************************************/
if (epreg_match("#block-CPG#", $_SERVER['PHP_SELF'])) {
...
while ($row = $db->sql_fetchrow($result)) {
    ...
    $content .= '<td align="center" valign="baseline"><a href="' . $CPG_M_URL . '&amp;file=displayimage&amp;meta=topn&amp;cat=0&amp;pid=' . $row["pid"] . '"><img src="' . get_pic_url($row, 'thumb') . '" border="0" alt="' . $thumb_title . '" title="' . $thumb_title . '"><br />' . $caption . '</a>&nbsp;&nbsp;</td>';
    $pic++;
} 
