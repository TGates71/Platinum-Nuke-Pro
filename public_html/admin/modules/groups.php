...
Opentable();
echo "<strong><center><a href='".$admin_file.".php?op=Groups'>Admin User Administration</a></center></strong>";
...
//    //GraphicAdmin();
	...
	if ($grp_num == 0) {
	    OpenTable();
	    echo "<center><font class=\"title\"><strong>" . _NOGROUPS . "</strong></font></center>";
	    CloseTable();
	    echo "<br />";
	} else {
	    OpenTable();
	    echo "<center><font class=\"title\"><strong>" . _UGROUPS . "</strong></font></center>"
		."<br /><table border=\"1\" width=\"100%\"><tr>"
		."<td align=\"center\" bgcolor=\"$bgcolor2\"><strong>" . _NAME . "</strong></td>"
		."<td align=\"center\" bgcolor=\"$bgcolor2\"><strong>" . _DESCRIPTION . "</strong></td>"
		."<td align=\"center\" bgcolor=\"$bgcolor2\"><strong>" . _POINTS . "</strong></td>"
		."<td align=\"center\" bgcolor=\"$bgcolor2\"><strong>" . _USERSCOUNT . "</strong></td>"
		."<td align=\"center\" bgcolor=\"$bgcolor2\"><strong>" . _FUNCTIONS . "</strong></td></tr>";
	...
	OpenTable();
	echo "<center><font class=\"option\"><strong>" . _ADDNEWGROUP . "</strong></font></center><br /><br />"
	...
	echo "<br />";
	OpenTable();
	echo "<center><font class=\"option\"><strong>" . _POINTSSYSTEM . "</strong></font></center><br /><br />"
...
//    //GraphicAdmin();
	title("" . _GROUPSADMIN . "");
	OpenTable();
	echo "<center><strong>" . _GROUPADDERROR . "</strong><br /><br />"
	    ."" . _NONUMVALUE . "<br /><br />"
	    ."" . _GOBACK . "</center>";
	CloseTable();
	include_once("footer.php");
...
//    //GraphicAdmin();
    ...
    $row = $db->sql_fetchrow($db->sql_query("SELECT * FROM " . $prefix . "_groups WHERE id='$id'"));
        ...
        $points = intval($row['points']);
    OpenTable();
    echo "<center><font class=\"option\"><strong>" . _EDITGROUP . "</strong></font></center><br /><br />"
        ."<form action=\"".$admin_file.".php\" method=\"post\">"
        ."<table border=\"0\" width=\"100%\">"
...
//    //GraphicAdmin();
	...
	$row = $db->sql_fetchrow($db->sql_query("SELECT name FROM " . $prefix . "_groups WHERE id='$id'"));
        $name = $row['name'];
	echo "<center><strong>" . _GROUPDELETE . "</strong><br /><br />"
	    ."" . _SUREGRPDEL1 . " <strong>$name</strong><br /><br />"
