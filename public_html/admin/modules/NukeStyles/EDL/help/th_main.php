...
echo "</head>";
echo "<body>";
echo "<font class=\"content\"><center><strong>"._NSDLHLPTHMAIN."</strong></center><br /><br />";
echo "<div align=\"justify\">";
echo "<strong>&#8226; "._NSDLHLPTHINSTALL."</strong><br />";
echo ""._NSDLHLPTHINSTALL2."<br /><br />";
echo "<strong>&#8226; "._NSDLHLPTHLOAD."</strong><br />";
echo ""._NSDLHLPTHLOAD2."<br /><br />";
echo "<strong>&#8226; "._NSDLHLPTHUNINSTALL."</strong><br />";
echo ""._NSDLHLPTHUNINSTALL2."<br /><br /><br />";
echo "<font class=\"tiny\">"._NSDLHLPTHMAINNOTE."</font><br /><br />";
echo "</div><br />";
