...
function ns_edl_table_list($id, $name, $mset, $mode) {
    ...
    list($name) = sql_fetch_array($result_th);
if ($mset == 1 && $mode == 2) {
    ns_dl_OpenTable();
    OpenTable2();
    echo "<center><font class=\"title\">"._NSDLTABLESETTINGS."</font></center>";
...
if ($mode == 2) {
    ...
    echo "</td></tr>";    
    echo "<tr><td align=\"center\" colspan=\"2\">";
    echo "<textarea name=\"html_open\" cols=\"75\" rows=\"20\"></textarea><br />";
    echo "<br /><br /></td></tr>";
    echo "<tr><td align=\"center\" colspan=\"2\">";
    echo "<strong>"._NSDLTBCUSTHTMLCLOSE."</strong>";
    echo "</td></tr>";
    echo "<tr><td align=\"center\" colspan=\"2\">";
    echo "<textarea name=\"html_close\" cols=\"75\" rows=\"20\"></textarea><br />";
    echo "</td></tr>";
    echo "<tr><td colspan=\"2\"><br /><br /></td></tr>";
    echo "<tr><td align=\"center\" colspan=\"2\">";
    echo "<font class=\"title\">"._NSDLACTTABLE."</font>";
...
function ns_edl_theme_uninstall($id, $name, $confirm = 0) {
    global $prefix, $db, $admin_file;
    if ($confirm == 1) {
	$db->sql_query("delete from ".$prefix."_ns_downloads_theme where id='$id'");
	$db->sql_query("delete from ".$prefix."_ns_downloads_theme_mode where id='$id'");
	$db->sql_query("delete from ".$prefix."_ns_downloads_table_form where id='$id'");
	$db->sql_query("delete from ".$prefix."_ns_downloads_table_html where id='$id'");
	Header("Location: ".$admin_file.".php?op=ns_edl_theme#theme");
    } else {
        $result = $db->sql_query("select id, name from ".$prefix."_ns_downloads_theme where id='$id'");
	list($id, $name) = sql_fetch_array($result);
    	if ($id == "") {
        Header("Location: ".$admin_file.".php?op=ns_edl_theme#theme");
    	} else {
...
if ($mode == 2) { 
    ...
    list($width, $cpad, $cspace, $align, $bdr, $bdrclr, $trclr, $tdclr, $bgclr, $bgimg) = sql_fetch_array($result2);   	 
    ns_dl_OpenTable();
    OpenTable2();
    echo "<center><font class=\"title\">"._NSDLTABLESETTINGS."</font></center>";
    CloseTable2();
 ...
 if ($align == "1") {
    ...
    list($html_open, $html_close, $act) = sql_fetch_array($result3);
    ns_dl_OpenTable();
    OpenTable2();
    echo "<center><font class=\"title\">"._NSDLTABLESETTINGS."</font></center>";
    CloseTable2();
    ...
    echo "</td></tr>";  
    echo "<tr><td align=\"center\" colspan=\"2\">";
    echo "<textarea name=\"html_open\" cols=\"75\" rows=\"20\">";
    ...
    echo "</td></tr>";
    echo "<tr><td align=\"center\" colspan=\"2\">";
    echo "<textarea name=\"html_close\" cols=\"75\" rows=\"20\">";
...
//    echo "</td></tr></table>";
    ...
    list($html_open, $html_close) = sql_fetch_array($result3);
    $html_open = stripslashes($html_open);
    $html_close = stripslashes($html_close);
    echo "<html>";
    echo "<head>";
...
switch($op) {
    ...
    include_once("admin/modules/NukeStyles/EDL/ns_edl_colorpick.php");
    break;
