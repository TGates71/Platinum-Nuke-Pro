...
$adminblock .= "<tr><td>";
$adminblock .= "<strong>&#8226;</strong> <a href=\"http://www.w2ibc.com/modules.php?name=Forums";
$adminblock .= "&file=viewforum&f=38\" target=\"_blank\">";
$adminblock .= "NS 3.0 Support Forum</a>";
$adminblock .= "</td></tr>";
$adminblock .= "</table>";
themesidebox($admintitle, $adminblock);
}
