...
######  Deleted Definitions from 1.0 - 1.6   ######

// define("_NSDLSETTINGS","NukeStyles.com Extra Downloads Settings");
// define("_NSDLPAGE","Results Per Page Options");
// define("_NSDLFEATUREINFO","Featured Download Information");
// define("_NSDLFEATURE","Featured Link Box Settings");
// define("_NSDLADDDOWNLOAD2","Below, choose to Allow Users in...........");
// define("_NSDLVOTE2","The options below determine............");
// define("_NSDLVOTE","Vote & Rating Options");
// define("_NSDLNEWPERPAGE","You can set the number of ..........");



######    New Definitions from 1.0 - 1.6   ######

define("_NSDLAUTOADDDOWNLOAD","Automatically validate new submissions?");



######  Modified Definitions from 1.0 - 1.6  ######
...
define("_NSDLEDLSETTINGS","Enhanced Downloads V3.0 Settings");
...
define("_NSDLMUSTADDMAINCAT","You need to add a <a href=\"admin.php?op=downloads_add_cat#addcat\">Main Category</a> before adding a Sub-Category.");
define("_NSDLMUSTADDDL","You need to add a <a href=\"admin.php?op=downloads_add#adddl\">New Download</a> before Modifying one. =)");
define("_NSDLUNEEDTOADDCAT","You need to add another <a href=\"admin.php?op=downloads_add_cat#addcat\">Category</a> before you can Transfer.");
define("_NSDLUNEEDTOADDCAT2","You need to add a <a href=\"admin.php?op=downloads_add_cat#addcat\">Category</a> before Modifying one. =)");
define("_NSDLUNEEDTOADDCAT3","You need to add a <a href=\"admin.php?op=downloads_add#adddl\">Category</a> before Adding a Download.");
...
define("_NSDLGENSETTINGS","Enhanced Downloads 3.0 General Settings");
...
define("_NSDLTABLESETTINGS","Enhanced Downloads 3.0 Theme & Table Configurations");
...
define("_NSDLTABLETITLE","NukeStyles EDL Table Test");
define("_NSUSE","Use");
...
define("_NSDLHLPTITLE","Enhanced Downloads 3.0 Admin Help");

// th_main.php

define("_NSDLHLPTHMAIN","Main Theme Configurations");
define("_NSDLHLPTHMAINNOTE","<strong>Note:</strong> Installing, Loading, or Uninstalling of themes for the Enhanced Downloads Module in no way effect any themes for the rest of your Website. The creating of tables are for the EDL V3.0 module <strong>only</strong>. So if you install or uninstall a particular theme, the regular themes for your site remain the same, and no changes are made to any loaded theme.");
...
define("_NSDLUPLOADSETTINGS","Enhanced Downloads 3.0 Upload Settings");
...
define("_NSDLGROUPSETTINGS","Enhanced Downloads 3.0 Group Settings");
...
define("_NSDLFIELDSSETTINGS","Enhanced Downloads 3.0 Field Settings");
...
define("_NSDLFLCOMING","Coming in a future release, will be the ability to enable/disable/rename 10 generic fields in the Download Module. This will allow admins to use more than the standard fields. For example: Fields for Platform, Price, OS, ect.");
...
define("_NSDLDESCRPTIMGSETTINGS","Enhanced Downloads 3.0 Description Image Settings");
...
define("_NSDLADDMODSETTINGS","Enhanced Downloads 3.0 Add/Modify Settings");
...
define("_NSDLRATESETTINGS","Enhanced Downloads 3.0 Rating Settings");
...
define("_NSDLFEATSETTINGS","Enhanced Downloads 3.0 Featured Links Settings");
...
define("_NSDLNEWPOPTOPSETTINGS","Enhanced Downloads 3.0 New-Popular-Top Rated Settings");
...
define("_NSDLMANAGEFLIMG","Enhanced Downloads 3.0 File & Image Management");
...
define("_NSDLFEATDOWNLOADS","Enhanced Downloads 3.0 Featured Downloads");
...
define("_NSDLRECOMSETTINGS","Enhanced Downloads 3.0 Recommend Download Settings");
